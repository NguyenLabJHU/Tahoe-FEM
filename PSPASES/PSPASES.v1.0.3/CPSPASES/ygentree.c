...
/* Subroutine */ int ygentree_(integer *n, integer *aptrs, integer *ainds, 
	integer *beginleafnode, integer *sizes, integer *parent, integer *
	tptrs, integer *tinds, integer *dd, integer *myid, integer *pp, 
	integer *wrkint, integer *asize, integer *recvsizs, integer *nrsiz, 
	MPI_Comm *comm)
{
...
/*  mpi_allgather__(beginleafnode, &c__1, &c__11, wrkint, &c__1, &c__11, comm,
	     &ierr); */
	MPI_Allgather(beginleafnode, 1, MPI_INT, wrkint, 1, MPI_INT, *comm);

/*     +                   wrkint(N),1,MPI_INTEGER,comm,ierr) */
/*<    >*/
