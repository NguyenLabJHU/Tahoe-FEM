	...
	prof, doublereal *dfopts, integer *ifopts, MPI_Comm *comm)
{
    ...
    extern /* Subroutine */ int dtrsm_(char *, char *, char *, char *, 
	    ...
	    doublereal *, integer *, ftnlen, ftnlen, ftnlen, ftnlen), mydsyrk_(
...
/*<           call mpi_get_count(mpistat,MPI_INTEGER,nbytes,ierr) >*/
	    myMPI_Get_count(mpistat, MPI_INT, &nbytes);
...
/*<    >*/
		i__1 = rank * *nrows << 3;
		myMPI_Isend(&vbuf_s__[1], i__1, MPI_BYTE, *mydown, *myid, *comm, &req[1]);
/*<           end if >*/
	    }
