/* $Id: RG_NeoHookean3D.cpp,v 1.2 2002-10-20 22:48:46 paklein Exp $ */
...
RG_NeoHookean3D::RG_NeoHookean3D(ifstreamT& in, const FiniteStrainT& element):
         RG_VDSplit3D(in,element),
	 fMu(2),
	 fKappa(2)
{
