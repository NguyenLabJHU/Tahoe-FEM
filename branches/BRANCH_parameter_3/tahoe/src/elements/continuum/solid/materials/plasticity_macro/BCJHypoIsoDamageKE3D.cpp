/* $Id: BCJHypoIsoDamageKE3D.cpp,v 1.7.46.1 2004-04-08 07:33:16 paklein Exp $ */
...
void BCJHypoIsoDamageKE3D::Print(ostream& out) const
{
  // inherited
  BCJHypo3D::Print(out);
...
void BCJHypoIsoDamageKE3D::PrintName(ostream& out) const
{
  // inherited
