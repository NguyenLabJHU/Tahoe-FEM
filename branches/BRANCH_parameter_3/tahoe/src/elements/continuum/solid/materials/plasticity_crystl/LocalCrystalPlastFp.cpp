/* $Id: LocalCrystalPlastFp.cpp,v 1.16.18.1 2004-04-08 07:33:13 paklein Exp $ */
...
void LocalCrystalPlastFp::Print(ostream& out) const
{
  // inherited
...
void LocalCrystalPlastFp::PrintName(ostream& out) const
{
  // inherited
