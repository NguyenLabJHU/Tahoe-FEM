/* $Id: FEManagerT_bridging_4.cpp,v 1.1.2.1 2004-05-22 03:07:09 paklein Exp $ */
...
//you are here!!!!!!
		...
		ComputeSum_signR_Na_4(ghost_neighbors_i, point_coords, overlap_node_i_map, sum_R_N);
		if (fPrintInput) {
...
void FEManagerT_bridging::ComputeSum_signR_Na_4(const RaggedArray2DT<int>& ghost_neighbors, 
