...
class nArray2DT: public nArrayT<nTYPE>
{
  public:
	...
	void Resize(int newmajordim, bool copy_in);
	void Resize(int newmajordim, const nTYPE& fill, bool copy_in); 
  	...
  	void ShallowCopy(const nArray2DT& RHS);
	...
	void Transpose(const nArray2DT<nTYPE>& source);
  	...
  	void ShallowRowCopy(int row, nArrayT<nTYPE>& array) const; 
  	void ColumnCopy(int col, nArrayT<nTYPE>& array) const;
  	
  	/* set values in batch */
	void SetRow(int row, const nTYPE& value);
  	void WriteRow(int row, const nTYPE* array);
  	void WriteRow(int row, const nArrayT<nTYPE>& array);
  	
	void SetColumn(int col, const nTYPE& value);
  	void WriteColumn(int col, const nArrayT<nTYPE>& array);
  	void WriteColumn(int col, const nTYPE* array);
	...
	/* I/O operators */	
	friend ostream& operator<<(ostream& out, const nArray2DT<nTYPE>& array)
	{
 ...
 * extra space is initialized by specifying the fill. */
template <class nTYPE> 
void nArray2DT<nTYPE>::Resize(int newmajordim, bool copy_in)
{
	/* inherited */
	nArrayT<nTYPE>::Resize(newmajordim*fMinorDim, copy_in, true);
...
template <class nTYPE> 
void nArray2DT<nTYPE>::Resize(int newmajordim, const nTYPE& fill, bool copy_in)
{
	/* inherited */
	nArrayT<nTYPE>::Resize(newmajordim*fMinorDim, fill, copy_in, true);
...
template <class nTYPE>
inline void nArray2DT<nTYPE>::ShallowCopy(const nArray2DT& RHS)
{
	/* inherited */
	nArrayT<nTYPE>::ShallowCopy(RHS);
...
template <class nTYPE>
inline void nArray2DT<nTYPE>::ShallowRowCopy(int row, 
...
/* set values in batch */
template <class nTYPE>  
void nArray2DT<nTYPE>::SetRow(int row, const nTYPE& value)
{
	nTYPE* prow = (*this)(row);
	for (int i = 0; i < fMinorDim; i++)
		*prow++ = value;
...
template <class nTYPE>  
inline void nArray2DT<nTYPE>::WriteRow(int row, const nTYPE* array)
{
	/* copy bytes */	
	memcpy((*this)(row), array, sizeof(nTYPE)*fMinorDim);	
}

template <class nTYPE>  
inline void nArray2DT<nTYPE>::WriteRow(int row, const nArrayT<nTYPE>& array)
{
/* range checking */
#if __option (extended_errorcheck)
	...
	/* copy bytes */	
	memcpy((*this)(row), array.Pointer(), sizeof(nTYPE)*fMinorDim);	
}
...
template <class nTYPE>  
void nArray2DT<nTYPE>::WriteColumn(int col, 
...
template <class nTYPE>  
void nArray2DT<nTYPE>::WriteColumn(int col, const nTYPE* array)
{
	nTYPE* pcol = &(*this)(0,col); 
	for (int i = 0; i < fMajorDim; i++)
	{
...
/* clear a row */
template <class nTYPE> 
inline void nArray2DT<nTYPE>::ClearRow(int row)
{
	/* set all bytes to 0! */
	memset((*this)(row), 0, sizeof(nTYPE)*fMinorDim);
}

/* clearing columns - clearing rows is inherited */
template <class nTYPE> 
void nArray2DT<nTYPE>::ClearColumn(int col)
{
	nTYPE* pcol = &(*this)(0,col); 
...
{
	/* byte copy */
	memcpy((*this)(copyrow), (*this)(fromrow), sizeof(nTYPE)*fMinorDim);	
}
...
void nArray2DT<nTYPE>::BlockRowCopyAt(const nArray2DT& source, int start)
{
	...
	/* copy bytes */
	if (source.Length() > 0)
		memcpy((*this)(start), source.Pointer(), 
			sizeof(nTYPE)*source.Length());
}
...
void nArray2DT<nTYPE>::BlockColumnCopyAt(const nArray2DT& source, int start)
{
	...
	for (int i = 0; i < fMajorDim; i++)
	  memcpy((*this)(i) + start, source(i), sizeof(nTYPE)*(source.fMinorDim));
}
