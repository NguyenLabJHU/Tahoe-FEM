...
int main(int argc, char* argv[])
{
  ...
  dem::assembly sample;
  sample.setThreshold(0.0001);	// control tessellation in granular strain calculation
  ////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  sample.ellipPile_Disp(50000,              // total_steps
		     ...
		     "penetration_particle_ini",// input file, initial particles, an ellipsoidal pile info added
