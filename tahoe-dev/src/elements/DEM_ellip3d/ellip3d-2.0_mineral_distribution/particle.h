...
namespace dem {
  ...
  public:
    ...
    particle(int id,int type, vec dim, vec position, vec dirca, vec dircb, vec dircc, REAL young, REAL poisson, REAL den);
    particle(int n, int type, vec center, gradation& grad, REAL young, REAL poisson);
    particle(int id,int type, vec dim, vec position, vec dirca, vec dircb, vec dircc, vec velocity, vec omga, REAL yng, REAL poi, REAL den); 
