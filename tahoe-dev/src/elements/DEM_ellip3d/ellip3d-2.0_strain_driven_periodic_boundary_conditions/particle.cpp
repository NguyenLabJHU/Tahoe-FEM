...
/*particle::particle(const particle &it){
    ID=it.ID;
    type=it.type;            
    a=it.a; b=it.b; c=it.c;   // three semi-axles, a>=b>=c
    young=it.young; poisson=it.poisson;
    curr_position=it.curr_position; prev_position=it.prev_position; prev_positionPB=it.prev_positionPB;
    init_position=it.init_position; start_position=it.start_position;
    curr_direction_a=it.curr_direction_a; 
    curr_direction_b=it.curr_direction_b; 
    curr_direction_c=it.curr_direction_c;
    prev_direction_a=it.prev_direction_a;
    prev_direction_b=it.prev_direction_b;
    prev_direction_c=it.prev_direction_c;
    curr_velocity=it.curr_velocity; prev_velocity=it.prev_velocity;
    curr_omga=it.curr_omga; prev_omga=it.prev_omga;
    curr_acceleration=it.curr_acceleration; prev_acceleration=it.prev_acceleration;
    pre_force=it.pre_force; force=it.force;
    pre_moment=it.pre_moment; moment=it.moment;
    const_force=it.const_force; const_moment=it.const_moment;
    flb_force=it.flb_force; flb_moment=it.flb_moment;
    mres=it.mres;
    density=it.density; mass=it.mass; volume=it.volume;
    J=it.J;
    kinetEnergy=it.kinetEnergy;
    cntnum=it.cntnum;
    inContact=it.inContact;
    IsFBP=it.IsFBP;
    GlobCoef();	// this is very important to calculate this again
}
*/
