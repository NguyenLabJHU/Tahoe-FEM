function dem_deposit_energy_normalized(fileToRead1)
...
transEnergy = transEnergy / mechaEnergy(1);
rotatEnergy = rotatEnergy / mechaEnergy(1);
kinetEnergy = kinetEnergy / mechaEnergy(1);
graviEnergy = graviEnergy / mechaEnergy(1);
mechaEnergy = mechaEnergy / mechaEnergy(1);
...
options.Format = 'png';
hgexport(fh, strcat(fileToRead1, '_energy_normalized.png'), options);
