...
Ni = 100;      % Number of steps/ iteration 
h = 0.1;      % Step size/ grid size
...
% Initial conditions
x(1) = 0;           % x_0
y1(1) = -1;          % y_0 for Euler's method
y2(1) = -1;          % y_0 for Modified-Euler's method
y3(1) = -1;          % y_0 for Runge-Kutta 4 method
