...
//#define LENGTH_CONVERSION 92165.8986
// 1000000 microns to meters; 92165.8986 to convert pixels (10.85 microns/pixel) to meters 
//#define LENGTH_CONVERSION 1000 // convert from mm to m, the original data in F-75 excel file is mm
#define LENGTH_CONVERSION 3.5*0.000001
...
int main(int argc, char *argv[])
{
	...
	double a_plus, a_minus, b_plus, b_minus, c_plus, c_minus;
...
*/
			...
			ofs << setw(16) << a_plus*LENGTH_CONVERSION;
			ofs << setw(16) << a_minus*LENGTH_CONVERSION;
			ofs << setw(16) << b_plus*LENGTH_CONVERSION;
			ofs << setw(16) << b_minus*LENGTH_CONVERSION;
			ofs << setw(16) << c_plus*LENGTH_CONVERSION;
			ofs << setw(16) << c_minus*LENGTH_CONVERSION;
			//if (aspectRatio < 1)
	...
	// Write column names
	ofs2 << "     ID         type        a_plus        a_minus        b_plus       b_minus " <<
			"        c_plus          c_minus          position_x      position_y" <<
