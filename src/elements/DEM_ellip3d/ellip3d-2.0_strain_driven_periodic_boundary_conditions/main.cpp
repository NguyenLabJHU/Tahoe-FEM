...
*/
    ...
    A.unixialCompressionPB2(50000,	// the timestep used in FEM and DEM may be different, so control the total_steps to keep the time the same
	    ...
	    1,  		// print interval for progress file
	    "input_particle_file", 
	    "input_boundary_file",
