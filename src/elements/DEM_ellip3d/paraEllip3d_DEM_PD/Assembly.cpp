...
namespace dem {
  ...
  void Assembly::scatterDEMPeriParticle() {
	...
	if (iRank == 0) {
	  ...
	  for (int i = 0; i < periParticleVec.size(); ++i)
...
//		continue;
	    sigma11=(*pt)->getSigma11(); sigma12=(*pt)->getSigma12(); sigma13=(*pt)->getSigma13();
	    sigma21=(*pt)->getSigma21(); sigma22=(*pt)->getSigma22(); sigma23=(*pt)->getSigma23();
	    sigma31=(*pt)->getSigma31(); sigma32=(*pt)->getSigma32(); sigma33=(*pt)->getSigma33();
