...
private:
    ...
    // this initBoundaryProjector is the position of this projector point in the initial
    Vec initBoundaryProjector;	
    Vec initBondVec;	// the initial bond vector pointing from the projector to the peri-point
    Vec currBondVec;	// the current bond vector pointing from the current boundary point to the peri-point
