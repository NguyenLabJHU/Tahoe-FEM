...
//Repository Example File - Isotropic Compression (input files:flo_particle_end and boundary_input.elp)
////////////////////////////////////////////////////////////////////////////////////////////////////
// header files
#include "realtypes.h"
#include "parameter.h"
...
*/
    ...
    dem::DMP_CNT       = 0.50;    // normal contact damping ratio
    dem::FRICTION      = 0.08;     // coefficient of friction between particles
    dem::BDRYFRIC      = 0.1;     // coefficient of friction between particle and rigid wall
    dem::COHESION      = 0;       // cohesion between particles, 5.0e+8

    // 3. boundary displacement rate
    dem::COMPRESS_RATE = 1.0e-04; // 7.0e-03 for triaxial; 1.0e-03 for isotropic and odometer.
    dem::RELEASE_RATE  = 1.0e-04; // the same as above
    dem::PILE_RATE     = 1.0e-04; // pile penetration velocity
   ...
   /*
    ...
    100,                // number of snapshots
    10,                 // print interval
    0,             // pre-existing ambient pressure from initial isotropic compression
    ...
    */
    A.BurstingDam2D(4000,              // total_steps
	       		100,           // number of snapshots   
	          	800,
			"dem_particle_input",
			"flo_boundary_end",
