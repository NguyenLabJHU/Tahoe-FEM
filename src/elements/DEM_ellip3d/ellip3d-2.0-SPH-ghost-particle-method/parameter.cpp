...
///// SPH parameters
REAL smoothLength;	// the smoothing length h
REAL soundSpeed;	// the sound of speed c(m/s), used to calculate pressure=c^2*density
REAL P0;
REAL gamma;
REAL sphDamping;
...
///// SPH parameters
REAL nu;	// kinematic viscosity which is used to calculate dynamic viscosity mu=density*nu;
REAL SPHInitialDensity;
