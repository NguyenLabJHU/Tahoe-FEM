...
namespace dem {
  ...
  public:
    ...
    REAL getPtclMinRadius() const {return size[sieveNum-1] * ratioCA;}	// may have problem for poly-ellipsoid, since size*ratioCA can get the minimum cplus, however
									// cminus is smaller than cplus. We may use size*ratioCA*0.2, since the minimum ratio for 
									// cminus to cplus is 0.2. July 3, 2015
  private:
