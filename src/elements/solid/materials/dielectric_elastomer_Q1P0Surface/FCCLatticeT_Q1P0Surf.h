#ifndef _FCC_LATTICE_T_Q1P0Surf_H_
#define _FCC_LATTICE_T_Q1P0Surf_H_
...
class FCCLatticeT_Q1P0Surf: public CBLatticeT, public ParameterInterfaceT
{
public:
	...
	/** constructor */
	FCCLatticeT_Q1P0Surf(int nshells, int normal);
...
#endif /* _FCC_LATTICE_T_Q1P0Surf_H_ */
