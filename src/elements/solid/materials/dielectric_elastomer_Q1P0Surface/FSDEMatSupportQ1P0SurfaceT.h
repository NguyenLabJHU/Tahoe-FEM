#if !defined(_FSDEMatSupportQ1P0SurfaceT_)
#define _FSDEMatSupportQ1P0SurfaceT_
...
namespace Tahoe {
  ...
  //
  class FSDielectricElastomerQ1P0SurfaceT;

  //
  // support for dielectric elastomer, finite strain Tahoe materials classes
  //
  class FSDEMatSupportQ1P0SurfaceT: public FSMatSupportT
  {
  ...
  public:
    ...
    // constructors
    //
    FSDEMatSupportQ1P0SurfaceT(int ndof, int nip);
    ...
    //
    const FSDielectricElastomerQ1P0SurfaceT* FSDielectricElastomerQ1P0Surface() const;
  ...
  private:
   ...
   const ArrayT<dArrayT>* fE_List;
    ...
    const FSDielectricElastomerQ1P0SurfaceT* fFSDielectricElastomerQ1P0Surface;

  };

} // namespace Tahoe

#include "FSDEMatSupportQ1P0SurfaceT.i.h"
#endif // _FSDEMatSupportQ1P0SurfaceT_
