...
/* Construct shells corresponding to atoms exactly on free Q1P0Surface */
/* Are combining bonds from Q1P0Surface and second Q1P0Surface clusters into the same bond
tables due to explanation give below */
/* Are actually counting ALL bonds; need to split energy in half for Q1P0Surface clusters */
...
/* constructor */
FCCLatticeT_Q1P0Surf::FCCLatticeT_Q1P0Surf(int nshells,int normal):
...
void FCCLatticeT_Q1P0Surf::DefineSubs(SubListT& sub_list) const
{
	/* inherited */
...
ParameterInterfaceT* FCCLatticeT_Q1P0Surf::NewSub(const StringT& name) const
{
...
void FCCLatticeT_Q1P0Surf::TakeParameterList(const ParameterListT& list)
{
	const char caller[] = "FCCLatticeT_Q1P0Surf::TakeParameterList";
...
void FCCLatticeT_Q1P0Surf::SetQ(const ParameterListT& list, dMatrixT& Q)
{
	const char caller[] = "FCCLatticeT_Q1P0Surf::SetQ";
...
/* Bond tables may repeat bonds; are combining bonds for free Q1P0Surface and one layer
in because assuming (1) deformation gradient F changes minimally between two atomic layers, and
(2) thus are using the same deformation gradient F to deform the bonds on the Q1P0Surface and one layer into
the bulk */
/* Q1P0Surface clusters correspond to "left" Q1P0Surface, i.e. with normal [-1,0,0] */
void FCCLatticeT_Q1P0Surf::LoadBondTable(void)
{
	...
	{ 1.0/sqrt2, 1.0/sqrt2,       0.0, // Q1P0Surface cluster (8 nearest neighbors)
	  ...
	  1.0/sqrt2,       0.0,-1.0/sqrt2,
	        ...
	        0.0, 1.0/sqrt2,-1.0/sqrt2,
			0.0,-1.0/sqrt2,-1.0/sqrt2,
	 -1.0/sqrt2,-1.0/sqrt2,       0.0, // New bonds for second Q1P0Surface cluster begin here
	 -1.0/sqrt2, 1.0/sqrt2,       0.0,
	 -1.0/sqrt2,       0.0, 1.0/sqrt2,
	 -1.0/sqrt2,       0.0,-1.0/sqrt2};

  	double bonddata2[10*3] =
	{sqrt2,   0.0,   0.0, // Q1P0Surface cluster (5 2nd shell neighbors)
	   0.0, sqrt2,   0.0,
	   0.0,   0.0, sqrt2,
	   0.0,-sqrt2,   0.0,
	   0.0,   0.0,-sqrt2,
	...
	{     sqrt2, 1.0/sqrt2, 1.0/sqrt2, // Q1P0Surface cluster (12 3rd shell neighbors)
      ...
      1.0/sqrt2,    -sqrt2,-1.0/sqrt2,
      1.0/sqrt2,-1.0/sqrt2,    -sqrt2,
	 -1.0/sqrt2,     sqrt2, 1.0/sqrt2, // New bonds for second Q1P0Surface cluster begin here
	 -1.0/sqrt2,     sqrt2,-1.0/sqrt2,
	 -1.0/sqrt2, 1.0/sqrt2,     sqrt2,
	 -1.0/sqrt2, 1.0/sqrt2,    -sqrt2,
	 -1.0/sqrt2,-1.0/sqrt2,     sqrt2,
...
dMatrixT FCCLatticeT_Q1P0Surf::RotationMatrixA(const double angle)
 {
	dMatrixT rmatrix(3);
	rmatrix = 0.0;
...
dMatrixT FCCLatticeT_Q1P0Surf::RotationMatrixB(const double angle)
{
	dMatrixT rmatrix(3);
	rmatrix = 0.0;
    rmatrix(0,0) = cos(angle);
