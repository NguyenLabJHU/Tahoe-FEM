/* $Id: C1GeometryBaseT.h,v 1.3 2003-11-19 20:38:24 rdorgan Exp $ */
...
public:
         ...
         *        nodes. Must be dimensioned: [ndof * nnd] */
         ...
         * \param Na destination for shape function evaluations: [nip] x [ndof * nnd]
         * \param Na_xx destination for shape function evaluations: [nip] x [ndof * nnd]
         * \param weights destination for weights of the integration rule: [nip] */
        virtual void SetLocalShape(dArray2DT& Na, dArray2DT& Na_xx,
