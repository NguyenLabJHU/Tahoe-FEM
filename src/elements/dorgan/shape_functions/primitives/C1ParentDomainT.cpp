/* $Id: C1ParentDomainT.cpp,v 1.3 2003-11-19 20:38:26 rdorgan Exp $ */
...
/* constructor */
C1ParentDomainT::C1ParentDomainT(C1GeometryT::CodeT geometry_code, int numIP, int numnodes, int numDOF):
        fC1GeometryCode(geometry_code),
        fNumSD(C1GeometryT::GeometryToNumSD(fC1GeometryCode)),
        fNumIP(numIP),
        fNumDOF(numDOF),
        fNumNodes(numnodes),
        fNa(fNumIP, fNumDOF*fNumNodes),
        fDDNa(fNumIP, fNumDOF*fNumNodes),
        fWeights(fNumIP),
        fNodalExtrap(fNumNodes,fNumIP),
        //        fJacobian(fNumSD),
        fNa_p(fNumDOF*fNumNodes),
        fDDNa_p(fNumDOF*fNumNodes)
{
...
void C1ParentDomainT::Initialize(void)
{
        ...
        fC1Geometry->SetLocalShape(fNa, fDDNa, fWeights);
...
//---------------------------------------------------------------------------
        ...
        //                n1[2] = m1[2]/j1;
        //                
        //                /* orthonormal, in-plane */ComputeDNa
        ...
        ////* compute nodal values:ComputeDNa
        //*
...
void C1ParentDomainT::Print(ostream& out) const
{
        ...
        out << "\n C1Parent domain shape function Laplacians:\n";
        fDDNa.WriteNumbered(out);
}
