/* $Id: C1DomainIntegrationT.cpp,v 1.3 2003-11-19 20:38:26 rdorgan Exp $ */
...
C1DomainIntegrationT::C1DomainIntegrationT(C1GeometryT::CodeT geometry_code, int numIP, int numnodes, int numDOF):
        fNumIP(numIP),
        fNumDOF(numDOF),
        fCurrIP(frefCurrIP),
        fDeleteDomain(1),
...
{
        /* set parent geometry */
        fC1Domain = new C1ParentDomainT(geometry_code, fNumIP, numnodes, fNumDOF);
