/* $Id: C1ShapeFunctionT.h,v 1.3 2003-11-19 20:38:26 rdorgan Exp $ */
...
//DEV - not used
        ...
        /** array of shape function Laplacian values defining the geometry */
        const double* IPShapeDDX(void) const;

        /** array of shape function values defining the field */
        const double* IPShapeU(void) const;

        /** array of shape function Laplacian values defining the field */
        const double* IPShapeDDU(void) const;
...
private:
        ...
        const dArray2DT*         pDDNaU;  // d^2(phi_U)/( d(fcoords)_i d(fcoords)_i )
...
/* data for the current integration point */
inline const double* C1ShapeFunctionT::IPShapeDDX(void) const
{
...
inline const double* C1ShapeFunctionT::IPShapeDDU(void) const
{
        return (*pDDNaU)(fCurrIP);
}
