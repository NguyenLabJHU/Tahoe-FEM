/* $Id: C1DomainIntegrationT.h,v 1.3 2003-11-19 20:38:26 rdorgan Exp $ */
...
public:
        ...
        C1DomainIntegrationT(C1GeometryT::CodeT geometry_code, int numIP, int numnodes, int numDOF);
        ...
        int NumDOF(void) const; /**< number of degrees of freedom */
        ...
        /** array nodal Laplacian shape functions at the "current" integration point */
        const double* IPDDShape(void) const;
...
protected:
        ...
        /** access to domain Laplacian shape functions */
...
inline int C1DomainIntegrationT::NumDOF(void) const { return fNumDOF; }
...
/* data for the current integration point */
inline const double* C1DomainIntegrationT::IPDDShape(void) const
{
        return fC1Domain->DDShape(fCurrIP);
}
...
/* access to domain Laplacian shape functions */
inline const dArray2DT& C1DomainIntegrationT::DDNa(void) const
{        
        return fC1Domain->DDNa();
}
