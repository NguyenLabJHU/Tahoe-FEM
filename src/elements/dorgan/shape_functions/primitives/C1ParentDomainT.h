/* $Id: C1ParentDomainT.h,v 1.3 2003-11-19 20:38:26 rdorgan Exp $ */
#ifndef _C1_PARENT_DOMAIN_T_H_
#define _C1_PARENT_DOMAIN_T_H_
...
class C1ParentDomainT
{
  public:
        ...
        C1ParentDomainT(C1GeometryT::CodeT geometry_code, int numIP, int numnodes, int numDOF);

        /** destructor */
        ~C1ParentDomainT(void);
        ...
        C1GeometryT::CodeT C1GeometryCode(void) const;
        /*@}*/

        /** reference to the parent domain geometry */
        const C1GeometryBaseT& C1Geometry(void) const;

        /** reference to the entire shape function array.
         * \return 2D array: [nip] x [nnd x fNumDOF] */
        const dArray2DT& Na(void) const;

        /** reference to the entire Laplacian shape function array.
         * \return 2D array: [nip] x [nnd x fNumDOF] */
        const dArray2DT& DDNa(void) const;
        
        /** pointer to the shape functions.
         * \param IPnum integration point number
         * \return pointer to array length numdof*numnodes */
	...
	/** pointer to the shape functions Laplacians.
	 * \param IPnum integration point number
	 * \return pointer to array length numdof*nnd */
	const double* DDShape(int IPnum) const;
        ...
        //        void FacetGeometry(ArrayT<C1GeometryT::CodeT>& facet_geom, iArrayT& facet_nodes) const;
  ...
  private:
        ...
        /** \name dimensions */
        /*@{*/
        C1GeometryT::CodeT fC1GeometryCode; /**< geometry shape code */
        int fNumSD;    /**< number of spatial dimensions */
        int fNumIP;    /**< number of integration points */
        int fNumDOF;   /**< number of degrees of freedom */
        ...
        dArrayT   fDDNa_p;      /**< array of shape function Laplacians */
        /*@}*/
};
...
inline int C1ParentDomainT::NumSD(void)        const { return fNumSD;        }
inline int C1ParentDomainT::NumIP(void)        const { return fNumIP;        }
inline int C1ParentDomainT::NumDOF(void)       const { return fNumDOF;       }
inline int C1ParentDomainT::NumNodes(void)     const { return fNumNodes;     }
inline C1GeometryT::CodeT C1ParentDomainT::C1GeometryCode(void) const { return fC1GeometryCode; }

/* reference to the parent domain geometry */
inline const C1GeometryBaseT& C1ParentDomainT::C1Geometry(void) const
{
        return *fC1Geometry;
}

/* access to domain shape functions */
inline const dArray2DT& C1ParentDomainT::Na(void) const { return fNa; }
inline const dArray2DT& C1ParentDomainT::DDNa(void) const { return fDDNa; }
inline const double* C1ParentDomainT::Shape(int IPnum) const { return fNa(IPnum); }
inline const double* C1ParentDomainT::DDShape(int IPnum) const { return fDDNa(IPnum); }
inline const double* C1ParentDomainT::Weight(void)     const { return fWeights.Pointer(); }

        ///* returns jacobian of the nodal values with respect
        //* to the variables of the shape function derivaties */
        //inline void C1ParentDomainT::DomainJacobian(const LocalArrayT& nodal, int numIP,
...
inline void C1ParentDomainT::EvaluateShapeFunctions(const dArrayT& coords, dArrayT& Na) const
{
        fC1Geometry->EvaluateShapeFunctions(coords, Na);
}

        //inline void C1ParentDomainT::EvaluateShapeFunctions(const dArrayT& coords, dArrayT& Na, 
        //        dArray2DT& DNa) const
        //{
        //        fC1Geometry->EvaluateShapeFunctions(coords, Na, DNa);
        //}

        ///* return the local node numbers for each facet of the element
        //* numbered to produce at outward normal in the order: vertex
        //* nodes, mid-edge nodes, mid-face nodes */
        //inline int C1ParentDomainT::NumFacets(void) const
        //{
        //        return fC1Geometry->NumFacets();
        //}

        //inline void C1ParentDomainT::NodesOnFacet(int facet, iArrayT& facetnodes) const
        //{
        //        fC1Geometry->NodesOnFacet(facet, facetnodes);
        //}

        //inline void C1ParentDomainT::NumNodesOnFacets(iArrayT& num_nodes) const
        //{
        //        fC1Geometry->NumNodesOnFacets(num_nodes);
        //}

        ///* returns the nodes on each facet needed to determine neighbors
        //* across facets */
        //inline void C1ParentDomainT::NeighborNodeMap(iArray2DT& facetnodes) const
        //{
        //        fC1Geometry->NeighborNodeMap(facetnodes);
        //}

        ///* return geometry and number of nodes on each facet */
        //inline void C1ParentDomainT::FacetGeometry(ArrayT<C1GeometryT::CodeT>& facet_geom,
        //        iArrayT& facet_nodes) const
        //{
        //        fC1Geometry->FacetGeometry(facet_geom, facet_nodes);
        //}

        ///* compute nodal values */
        //inline void C1ParentDomainT::NodalValues(const dArrayT& IPvalues, dArrayT& nodalvalues) const
        //{
        //        fNodalExtrap.Multx(IPvalues, nodalvalues);
        //}

} // namespace Tahoe 
#endif /* _C1_PARENT_DOMAIN_T_H_ */
