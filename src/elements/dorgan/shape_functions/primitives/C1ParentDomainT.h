/* $Id: C1ParentDomainT.h,v 1.1 2003-09-29 19:59:03 rdorgan Exp $ */
...
class C1ParentDomainT
{
  public:
	...
	C1ParentDomainT(C1GeometryT::CodeT geometry_code, int numIP, int numnodes);
...
inline const double* C1ParentDomainT::DShape(int IPnum, int dim) const
{
