...
//        out_variable.CopyIn(6,fTemp_six_values);
          ...
          out_variable[27]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+ktrS);
          out_variable[28]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kinvdevS);
          out_variable[29]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+ktrSIGMA_S);
          out_variable[30]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kinvdevSIGMA_S);
          out_variable[31]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kinvtrM);
          out_variable[32]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kinvdevM);
          out_variable[33]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kinvPhi);
          out_variable[34]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kinvGPhi);
          out_variable[35]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kc_chi);
          out_variable[36]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+khc_chi);
          out_variable[37]=fState_variables_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kDelgammachi);
...
/*************************************************************************************************************/
	    		...
	    		fChip_inverse.Inverse(fChip);                                                
                	...
                	PSIe_tr.MultATB(fFe_tr,fChie_tr);
                        ...
                        /* Initially Aphi_chi is already assigined to fState_variables_n_IPs(IP,khc)=Aphi in TakeParameterList function*/
                        //double Beta=-1.0;
                ...
                /* initial Delgamma,Delgammchi, their increments */
					...
					Temp_inv=Elastic_LagrangianStn.Trace();
        	                        ...
        	                        fTemp_matrix_nsd_x_nsd.SetToScaled(2*fMaterial_Params[kSigma_const],Elastic_LagrangianStn);
                                        ...
                                        // Calculate micro yield function with updated parameters
                                        fMicroYield_function=devSIGMA_S_inv-(Aphi_chi*(fState_variables_IPs(IP,kc_chi))-Bphi_chi*mean_stress);
                                        fs_micromorph3D_out<<"Current Macro relative residual = "<< fabs(fMicroYield_function/fMicroYield_function_tr)<<" && "<< "Current Micro relative residual = " << fabs(fMicroYield_function/fMicroYield_function_tr) << endl;                                                                                         
...
//                                      fRight_Elastic_Cauchy_Green_tensor = fIdentity_matrix;
                                ...
                                // fCauchy_stress_tensor_current_IP=Sigma;
                                /* For plotting purposes  it is set to the Second Piola Kirchhoff Stress Tensor in Bbar */
                                fCauchy_stress_tensor_current_IP=SPK;
				...
				fD1=fTemp_matrix_nsd_x_nsd;		                                              
                                ...
                                fdFYchidSIGMA_S_fD1=dMatrixT::Dot(fdFYchidSIGMA_S,fD1);                                

                                /* define dFYchi/dSIGMA_S:D^T */
                                fTemp_matrix_nsd_x_nsd.Transpose(fD1);
                                fdFYchidSIGMA_S_fD1T=dMatrixT::Dot(fdFYchidSIGMA_S,fTemp_matrix_nsd_x_nsd);
                                
                                /* define dFYchi/dSIGMA_S:1 */
                                dFYchidSIGMA_Scol1=dMatrixT::Dot(fdFYchidSIGMA_S,fIdentity_matrix);   
				...
				fdFYchidSIGMA_S_fA1=dMatrixT::Dot(fdFYchidSIGMA_S,fA1);   
				
                                /* define dFYchi/dSIGMA_S:A^T*/
                                fTemp_matrix_nsd_x_nsd.Transpose(fA1);                                                                
				fdFYchidSIGMA_S_fA1T=dMatrixT::Dot(fdFYchidSIGMA_S,fTemp_matrix_nsd_x_nsd);  
				
                                /* define dFYchi/dSIGMA_S:N*/
				fdFYchidSIGMA_S_fN1=dMatrixT::Dot(fdFYchidSIGMA_S,fN1);   
				
                                /* define dFYchi/dSIGMA_S:N^T*/
                                fTemp_matrix_nsd_x_nsd.Transpose(fN1);                                                                
				fdFYchidSIGMA_S_fN1T=dMatrixT::Dot(fdFYchidSIGMA_S,fTemp_matrix_nsd_x_nsd); 				 				
				...
				+(fMaterial_Params[kNu]-fMaterial_Params[kSigma_const])*fdFYchidSIGMA_S_fN1T
				+(fMaterial_Params[kKappa]-fMaterial_Params[kSigma_const])*fdFYchidSIGMA_S_fN1;			
												                                             
                                
                                fConst4=(fMaterial_Params[kEta]-fMaterial_Params[kTau])*dFYchidSIGMA_Scol1*trfD1  
                                +(fMaterial_Params[kNu]-fMaterial_Params[kSigma_const])*fdFYchidSIGMA_S_fD1
                                +(fMaterial_Params[kKappa]-fMaterial_Params[kSigma_const])*fdFYchidSIGMA_S_fD1T
...
*/
                 		...
                 		Form_IIJp_1();
                   	 	...
                   	 	fTemp_matrix_nsd_x_nsd.MultAB(fTemp_matrix_nsd_x_nsd2,fFp_n);
                                ...
                                /* Terms related to delta (Jp) delta(Jp)w(l,A)(F^-1)(A,k) delta(Fe)(k,Kbar)S(Kbar,Lbar)Fe(l,Lbar)  */
                                /* define matrix A2 */
                                ...
                                *scale_const*Jp;
                                ...
                                if(PlasticityCondition==2 && PlasticityCondition==3)
                                {
                                ...
                                *fMaterial_Params[kLambda]*dFYchidSIGMA_Scol1;
                                fTemp_matrix_nudof_x_nudof *= scale;
    ...
    while (NextElement())
    {
        ...
        for (l=0; l < fNumIP_displ; l++)
        {
         ...
         fState_variables_n_Elements_IPs(e,l*kNUM_FMATERIAL_STATE_TERMS+kinvGPhi)=0.0;
            ...
            fdGchidSIGMA_S_n_IPs.SetRow(l,fdGchidSIGMA_S_n);//                                        
        ...
        fdGchidSIGMA_S_n_Elements_IPs.SetRow(e,fdGchidSIGMA_S_n_IPs);            
    }
    ...
    for(int i=0;i<3;i++)
    {
        for(int j=0;j<3;j++)
        {
            for( int k=0;k<3;k++)
            {
                //for(a=0;a<3;a++)
                //{
                fdevMKLM(i,j,k)=fMKLM(i,j,k)-(1/3)*fIdentity_matrix(i,j)*fMKLM(0,0,k)
                                            -(1/3)*fIdentity_matrix(i,j)*fMKLM(1,1,k)
                                            -(1/3)*fIdentity_matrix(i,j)*fMKLM(2,2,k);
                //}
            }
...
void FSMicromorphic3DT :: Calculate_PHI_GPHI_matrices_INV()
{
    invPhi=0.0;
    invGPhi=0.0;
    temp_inv=0.0;
...
void FSMicromorphic3DT:: Form_fV2p()
{
    int row=0;
    fV2p=0.0;
    //fTemp_matrix_nsd_x_nsd=0.0;
...
void FSMicromorphic3DT:: Form_IJp_1()
{
    int row=0;
    int col=0;
    IJp_1=0.0;
...
void FSMicromorphic3DT:: Form_IJp_2()
{
    int row=0;
    int col=0;
    IJp_2=0.0;
...
void FSMicromorphic3DT:: Form_IJp_3()
{
    int row=0;
    int col=0;
    IJp_3=0.0;
...
void FSMicromorphic3DT:: Form_IJp_4()
{
    int row=0;
    int col=0;
    IJp_4=0.0;
...
void FSMicromorphic3DT:: Form_IJp_5()
{
    int row=0;
    int col=0;
    IJp_5=0.0;
...
void FSMicromorphic3DT:: Form_IJp_6()
{
    int row=0;
    int col=0;
    IJp_6=0.0;
...
void FSMicromorphic3DT:: Form_IJp_7()
{
    int row=0;
    int col=0;
    IJp_7=0.0;
...
void FSMicromorphic3DT:: Form_IJp_8()
{
    int row=0;
    int col=0;
    IJp_8=0.0;
...
void FSMicromorphic3DT:: Form_IJp_9()
{
    int row=0;
    int col=0;
    IJp_9=0.0;
...
void FSMicromorphic3DT:: Form_IJp_10()
{
...
void FSMicromorphic3DT:: Form_IJp_11()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IJp_11(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IJp_12()
{
...
void FSMicromorphic3DT:: Form_IJp_13()
{
...
void FSMicromorphic3DT:: Form_IJp_14()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IJp_14(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IJp_15()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IJp_15(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IJp_16()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IJp_16(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IJp_17()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IJp_17(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I1e_1()
{
    int row=0;
    int col=0;
    I1e_1=0.0;
...
void FSMicromorphic3DT:: Form_I2e_1()
{
    int row=0;
    int col=0;
    I2e_1=0.0;
...
void FSMicromorphic3DT:: Form_I2p_2()
{
    int row=0;
    int col=0;
    I2p_2=0.0;
...
void FSMicromorphic3DT:: Form_I2p_3()
{
    int row=0;
    int col=0;
    I2p_3=0.0;
...
void FSMicromorphic3DT:: Form_I2p_4()
{
    int row=0;
    int col=0;
    I2p_4=0.0;
...
void FSMicromorphic3DT:: Form_I2p_5()
{
    int row=0;
    int col=0;
    I2p_5=0.0;
        ...
        for(int i=0;i<3;i++)
        {
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                        I2p_5(row,col)+=fA2(A,l)*fChie(i,Abar)*fFp_inverse(M,Abar);
                    }
                    row++;
                }
            }
...
void FSMicromorphic3DT:: Form_I2p_6()
{
    int row=0;
    int col=0;
    I2p_6=0.0;
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Mbar=0;Mbar<3;Mbar++)
                    {
                        for(int Nbar=0;Nbar<3;Nbar++)
                        {
                            I2p_6(row,col)+=fA2(A,l)*fdFYdS(Mbar,Nbar)*fChie(i,Nbar)*fFp_inverse(M,Mbar);
                        }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_7()
{
    int row=0;
    int col=0;
    I2p_7=0.0;
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Mbar=0;Mbar<3;Mbar++)
                    {
                        for(int Nbar=0;Nbar<3;Nbar++)
                        {
                            I2p_7(row,col)+=fA2(A,l)*fdFYdS(Mbar,Nbar)*fChie(i,Mbar)*fFp_inverse(M,Nbar);
                        }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_8()
{
    int row=0;
    int col=0;
    I2p_8=0.0;
        ...
        for(int i=0;i<3;i++)
        {
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                        I2p_8(row,col)+=fA2(A,l)*fFe(i,Abar)*fChip_inverse(M,Abar);
                    }
                    row++;
                }
            }
...
void FSMicromorphic3DT:: Form_I2p_9()
{
    int row=0;
    int col=0;
    I2p_9=0.0;
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                        for(int Bbar=0;Bbar<3;Bbar++)
                        {
                            I2p_9(row,col)+=fA2(A,l)*fdFYdS(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(M,Bbar);
                        }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_10()
{
    int row=0;
    int col=0;
    I2p_10=0.0;
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                        for(int Bbar=0;Bbar<3;Bbar++)
                        {
                            I2p_10(row,col)+=fA2(A,l)*fdFYdS(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(M,Abar);
                        }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_11()
{
        ...
        for(int i=0;i<3;i++)
        {
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
	                    I2p_11(row,col)+=fA2(A,l)*fFe(i,Abar)*fFp_inverse(B,Abar);
                    }
                    row++;
                }
            }
...
void FSMicromorphic3DT:: Form_I2p_12()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I2p_12(row,col)+=fA2(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_13()
{
        ...
        for(int i=0;i<3;i++)
        {
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
	                    I2p_13(row,col)+=fA2(A,l)*fChie(i,Abar)*fFp_inverse(B,Abar);
                    }
                    row++;
                }
            }
...
void FSMicromorphic3DT:: Form_I2p_14()
{
        ...
        for(int i=0;i<3;i++)
        {
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
	                    I2p_14(row,col)+=fA2(A,l)*fFe(i,Abar)*fChip_inverse(B,Abar);
                    }
                    row++;
                }
            }
...
void FSMicromorphic3DT:: Form_I2p_15()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I2p_15(row,col)+=fA2(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_16()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I2p_16(row,col)+=fA2(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_17()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I2p_17(row,col)+=fA2(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I2p_18()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I2p_18(row,col)+=fA2(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_22()
{
    int row=0;
    int col=0;
    I3p_22=0.0;
...
void FSMicromorphic3DT:: Form_I3p_23()
{
    int row=0;
    int col=0;
    I3p_23=0.0;
...
void FSMicromorphic3DT:: Form_I3p_24()
{
    int row=0;
    int col=0;
    I3p_24=0.0;
...
void FSMicromorphic3DT:: Form_I3p_25()
{
    int row=0;
    int col=0;
    I3p_25=0.0;
...
void FSMicromorphic3DT:: Form_I3p_26()
{
    int row=0;
    int col=0;
    I3p_26=0.0;
...
void FSMicromorphic3DT:: Form_I3p_27()
{
    int row=0;
    int col=0;
    I3p_27=0.0;
...
void FSMicromorphic3DT:: Form_I3p_28()
{
    int row=0;
    int col=0;
    I3p_28=0.0;
...
void FSMicromorphic3DT:: Form_I3p_29()
{
    int row=0;
    int col=0;
    I3p_29=0.0;
...
void FSMicromorphic3DT:: Form_I3p_30()
{
    int row=0;
    int col=0;
    I3p_30=0.0;
...
void FSMicromorphic3DT:: Form_I3p_31()
{
    int row=0;
    int col=0;
    I3p_31=0.0;
...
void FSMicromorphic3DT:: Form_I3p_32()
{
    int row=0;
    int col=0;
    I3p_32=0.0;
...
void FSMicromorphic3DT:: Form_I3p_33()
{
    int row=0;
    int col=0;
    I3p_33=0.0;
...
void FSMicromorphic3DT:: Form_I3p_34()
{
    int row=0;
    int col=0;
    I3p_34=0.0;
...
void FSMicromorphic3DT:: Form_I3p_35()
{
    int row=0;
    int col=0;
    I3p_35=0.0;
...
void FSMicromorphic3DT:: Form_I3p_36()
{
    int row=0;
    int col=0;
    I3p_36=0.0;
...
void FSMicromorphic3DT:: Form_I3e_37()
{
    int row=0;
    int col=0;
    I3e_37=0.0;
...
void FSMicromorphic3DT:: Form_I3e_38()
{
    int row=0;
    int col=0;
    I3e_38=0.0;
...
void FSMicromorphic3DT:: Form_I3e_39()
{
    int row=0;
    int col=0;
    I3e_39=0.0;
...
void FSMicromorphic3DT:: Form_I3p_40()
{
    int row=0;
    int col=0;
    I3p_40=0.0;
...
void FSMicromorphic3DT:: Form_I3p_41()
{
    int row=0;
    int col=0;
    I3p_41=0.0;
...
void FSMicromorphic3DT:: Form_I3p_42()
{
    int row=0;
    int col=0;
    I3p_42=0.0;
...
void FSMicromorphic3DT:: Form_I3p_43()
{
    int row=0;
    int col=0;
    I3p_43=0.0;
...
void FSMicromorphic3DT:: Form_I3p_44()
{
    int row=0;
    int col=0;
    I3p_44=0.0;
...
void FSMicromorphic3DT:: Form_I3p_45()
{
    int row=0;
    int col=0;
    I3p_45=0.0;
...
void FSMicromorphic3DT:: Form_I3p_46()
{
    int row=0;
    int col=0;
    I3p_46=0.0;
...
void FSMicromorphic3DT:: Form_I3p_47()
{
    int row=0;
    int col=0;
    I3p_47=0.0;
...
void FSMicromorphic3DT:: Form_I3p_48()
{
    int row=0;
    int col=0;
    I3p_48=0.0;
...
void FSMicromorphic3DT:: Form_I3p_49()
{
    int row=0;
    int col=0;
    I3p_49=0.0;
...
void FSMicromorphic3DT:: Form_I3p_50()
{
    int row=0;
    int col=0;
    I3p_50=0.0;
...
void FSMicromorphic3DT:: Form_I3p_51()
{
    int row=0;
    int col=0;
    I3p_51=0.0;
...
void FSMicromorphic3DT:: Form_I3p_52()
{
    int row=0;
    int col=0;
    I3p_52=0.0;
...
void FSMicromorphic3DT:: Form_I3p_53()
{
    int row=0;
    int col=0;
    I3p_53=0.0;
...
void FSMicromorphic3DT:: Form_I3p_54()
{
    int row=0;
    int col=0;
    I3p_54=0.0;
...
void FSMicromorphic3DT:: Form_I3p_55()
{
...
void FSMicromorphic3DT:: Form_I3p_56()
{
                    ...
                    for(int l=0;l<3;l++)
                    {
                        ...
                        {	
                  		for(int Bbar=0;Bbar<3;Bbar++)
                        	...
                        	I3p_56(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
                        	}
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_57()
{
...
void FSMicromorphic3DT:: Form_I3p_58()
{
...
void FSMicromorphic3DT:: Form_I3p_59()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_59(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_60()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_60(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_61()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_61(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_62()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_62(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_63()
{
...
void FSMicromorphic3DT:: Form_I3p_64()
{
                    ...
                    for(int l=0;l<3;l++)
                    {
                        ...
                        {	
                  		for(int Bbar=0;Bbar<3;Bbar++)
                        	...
                        	I3p_64(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
                        	}
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_65()
{
...
void FSMicromorphic3DT:: Form_I3p_66()
{
...
void FSMicromorphic3DT:: Form_I3p_67()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_67(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_68()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_68(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_69()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_69(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_70()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_70(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_71()
{
...
void FSMicromorphic3DT:: Form_I3p_72()
{
                    ...
                    for(int l=0;l<3;l++)
                    {
                        ...
                        {	
                  		for(int Bbar=0;Bbar<3;Bbar++)
                        	...
                        	I3p_72(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
                        	}
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_73()
{
...
void FSMicromorphic3DT:: Form_I3p_74()
{
...
void FSMicromorphic3DT:: Form_I3p_75()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_75(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_76()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_76(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_77()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_77(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_78()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	I3p_78(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_I3p_79()
{
...
void FSMicromorphic3DT:: Form_I3p_80()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_80(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_81()
{
...
void FSMicromorphic3DT:: Form_I3p_82()
{
...
void FSMicromorphic3DT:: Form_I3p_83()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_83(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_84()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_84(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_85()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   I3p_85(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_86()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_86(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_87()
{
...
void FSMicromorphic3DT:: Form_I3p_88()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_88(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_89()
{
...
void FSMicromorphic3DT:: Form_I3p_90()
{
...
void FSMicromorphic3DT:: Form_I3p_91()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_91(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_92()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_92(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_93()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   I3p_93(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_94()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   I3p_94(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_95()
{
...
void FSMicromorphic3DT:: Form_I3p_96()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_96(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_97()
{
...
void FSMicromorphic3DT:: Form_I3p_98()
{
...
void FSMicromorphic3DT:: Form_I3p_99()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_99(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_100()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_100(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_101()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   I3p_101(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_102()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_102(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_103()
{
...
void FSMicromorphic3DT:: Form_I3p_104()
{
...
void FSMicromorphic3DT:: Form_I3p_105()
{
...
void FSMicromorphic3DT:: Form_I3p_106()
{
        ...
        for(int i=0;i<3;i++)
        {
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                         I3p_105(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fFe(i,Abar)*fChip_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_I3p_107()
{
...
void FSMicromorphic3DT:: Form_I3p_108()
{
...
void FSMicromorphic3DT:: Form_I3p_109()
{
...
void FSMicromorphic3DT:: Form_I3p_110()
{
...
void FSMicromorphic3DT:: Form_I3p_111()
{
...
void FSMicromorphic3DT:: Form_I3p_112()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_112(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_113()
{
...
void FSMicromorphic3DT:: Form_I3p_114()
{
...
void FSMicromorphic3DT:: Form_I3p_115()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_115(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_116()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_116(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_117()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   I3p_117(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_118()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_118(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_119()
{
...
void FSMicromorphic3DT:: Form_I3p_120()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_120(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_121()
{
...
void FSMicromorphic3DT:: Form_I3p_122()
{
...
void FSMicromorphic3DT:: Form_I3p_123()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_123(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_124()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_124(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_125()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   I3p_125(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_126()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I3p_126(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I3p_127()
{
...
void FSMicromorphic3DT:: Form_I3p_128()
{
...
void FSMicromorphic3DT:: Form_I3p_129()
{
...
void FSMicromorphic3DT:: Form_I3p_130()
{
...
void FSMicromorphic3DT:: Form_I3p_131()
{
...
void FSMicromorphic3DT:: Form_I3p_132()
{
...
void FSMicromorphic3DT:: Form_I3p_133()
{
...
void FSMicromorphic3DT:: Form_I3p_134()
{
...
void FSMicromorphic3DT:: Form_I3p_135()
{
...
void FSMicromorphic3DT:: Form_I3p_136()
{
...
void FSMicromorphic3DT:: Form_I3p_137()
{
...
void FSMicromorphic3DT:: Form_I3p_138()
{
...
void FSMicromorphic3DT:: Form_I3p_139()
{
...
void FSMicromorphic3DT:: Form_I3p_140()
{
...
void FSMicromorphic3DT:: Form_I3p_141()
{
...
void FSMicromorphic3DT:: Form_I3p_142()
{
...
void FSMicromorphic3DT:: Form_I4p_8()
{
    int row=0;
    int col=0;
    I4p_8=0.0;
...
void FSMicromorphic3DT:: Form_I4p_9()
{
    int row=0;
    int col=0;
    I4p_9=0.0;
...
void FSMicromorphic3DT:: Form_I4p_10()
{
    int row=0;
    int col=0;
    I4p_10=0.0;
...
void FSMicromorphic3DT:: Form_I4p_11()
{
...
void FSMicromorphic3DT:: Form_I4p_12()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I4p_12(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I4p_13()
{
...
void FSMicromorphic3DT:: Form_I4p_14()
{
...
void FSMicromorphic3DT:: Form_I4p_15()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I4p_15(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I4p_16()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I4p_16(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I4p_17()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   I4p_17(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_I4p_18()
{
            ...
            for(int A=0;A<3;A++)
            {
                for(int l=0;l<3;l++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    I4p_18(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT :: Form_IIJp_1()
{
    int row=0;
    int col=0;
    IIJp_1=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_2()
{
    int row=0;
    int col=0;
    IIJp_2=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_3()
{
    int row=0;
    int col=0;
    IIJp_3=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_4()
{
    int row=0;
    int col=0;
    IIJp_4=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_5()
{
    int row=0;
    int col=0;
    IIJp_5=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_6()
{
    int row=0;
    int col=0;
    IIJp_6=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_7()
{
    int row=0;
    int col=0;
    IIJp_7=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_8()
{
    int row=0;
    int col=0;
    IIJp_8=0.0;
...
void FSMicromorphic3DT:: Form_IIJp_9()
{
...
void FSMicromorphic3DT:: Form_IIJp_10()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IIJp_10(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IIJp_11()
{
...
void FSMicromorphic3DT:: Form_IIJp_12()
{
...
void FSMicromorphic3DT:: Form_IIJp_13()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IIJp_13(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IIJp_14()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IIJp_14(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IIJp_15()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IIJp_15(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_IIJp_16()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    IIJp_16(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II2e_1()
{
    int row=0;
    int col=0;
    II2e_1=0.0;
...
void FSMicromorphic3DT:: Form_II2p_2()
{
    int row=0;
    int col=0;
    II2p_2=0.0;
...
void FSMicromorphic3DT:: Form_II2p_3()
{
    int row=0;
    int col=0;
    II2p_3=0.0;
...
void FSMicromorphic3DT:: Form_II2p_4()
{
    int row=0;
    int col=0;
    II2p_4=0.0;
...
void FSMicromorphic3DT:: Form_II2p_5()
{
    int row=0;
    int col=0;
    II2p_5=0.0;
...
void FSMicromorphic3DT:: Form_II2p_6()
{
    int row=0;
    int col=0;
    II2p_6=0.0;
...
void FSMicromorphic3DT:: Form_II2p_7()
{
    int row=0;
    int col=0;
    II2p_7=0.0;
...
void FSMicromorphic3DT:: Form_II2p_8()
{
    int row=0;
    int col=0;
    II2p_8=0.0;
...
void FSMicromorphic3DT:: Form_II2p_9()
{
    int row=0;
    int col=0;
    II2p_9=0.0;
...
void FSMicromorphic3DT:: Form_II2p_10()
{
...
void FSMicromorphic3DT:: Form_II2p_11()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II2p_11(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II2p_12()
{
...
void FSMicromorphic3DT:: Form_II2p_13()
{
...
void FSMicromorphic3DT:: Form_II2p_14()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II2p_14(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II2p_15()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   II2p_15(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II2p_16()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II2p_16(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II2p_17()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II2p_17(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3e_1()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3e_2()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3e_3()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3e_4()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3e_5()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_6()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_7()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_8()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_9()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_10()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_11()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_12()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_13()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_14()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_15()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_16()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_17()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_18()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_19()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_20()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_21()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_22()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_23()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_24()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_25()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_26()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_27()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_28()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_29()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_30()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3e_31()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3e_32()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3e_33()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_34()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_35()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_36()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_37()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_38()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_39()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_40()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_41()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_42()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_43()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_44()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_45()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_46()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_47()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_48()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II3p_49()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	II3p_49(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fFe(i,Abar)*fFp_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_50()
{
                    ...
                    for(int l=0;l<3;l++)
                    {
                        ...
                        {	
                  		for(int Bbar=0;Bbar<3;Bbar++)
                        	...
                        	II3p_50(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
                        	}
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_51()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {	    	                        	
	                       	II3p_51(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fChie(i,Abar)*fFp_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_52()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {	    	                        	
	                       	II3p_52(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fFe(i,Abar)*fChip_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_53()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_53(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_54()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_54(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_55()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_55(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_56()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_56(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_57()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	II3p_57(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fFe(i,Abar)*fFp_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_58()
{
                    ...
                    for(int l=0;l<3;l++)
                    {
                        ...
                        {	
                  		for(int Bbar=0;Bbar<3;Bbar++)
                        	...
                        	II3p_58(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
                        	}
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_59()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {	    	                        	
	                       	II3p_59(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fChie(i,Abar)*fFp_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_60()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {	    	                        	
	                       	II3p_60(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fFe(i,Abar)*fChip_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_61()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_61(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_62()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_62(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_63()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_63(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_64()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_64(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_65()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	II3p_65(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fFe(i,Abar)*fFp_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_66()
{
                    ...
                    for(int l=0;l<3;l++)
                    {
                        ...
                        {	
                  		for(int Bbar=0;Bbar<3;Bbar++)
                        	...
                        	II3p_66(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
                        	}
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_67()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {	    	                        	
	                       	II3p_67(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fChie(i,Abar)*fFp_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_68()
{
            ...
            for(int i=0;i<3;i++)
            {
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {	    	                        	
	                       	II3p_68(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fFe(i,Abar)*fChip_inverse(B,Abar);
...
void FSMicromorphic3DT:: Form_II3p_69()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_69(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_70()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_70(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_71()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_71(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_72()
{
                ...
                for(int A=0;A<3;A++)
                {
                    for(int l=0;l<3;l++)
                    {
                        ...
                        for(int Abar=0;Abar<3;Abar++)
                        {
                        	for(int Bbar=0;Bbar<3;Bbar++)
                        	{                        	    	                        	
	                   	II3p_72(row,col)+=fTemp_matrix_nsd_x_nsd(A,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                	}       	                  
                        }
                        row++;
                    }
...
void FSMicromorphic3DT:: Form_II3p_73()
{
...
void FSMicromorphic3DT:: Form_II3p_74()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_74(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_75()
{
...
void FSMicromorphic3DT:: Form_II3p_76()
{
...
void FSMicromorphic3DT:: Form_II3p_77()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_77(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_78()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   II3p_78(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_79()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_79(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_80()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_80(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_81()
{
...
void FSMicromorphic3DT:: Form_II3p_82()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_82(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_83()
{
...
void FSMicromorphic3DT:: Form_II3p_84()
{
...
void FSMicromorphic3DT:: Form_II3p_85()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_85(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_86()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   II3p_86(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_87()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_87(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_88()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_88(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_89()
{
...
void FSMicromorphic3DT:: Form_II3p_90()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_90(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*(fFe(i,Bbar)*fFp_inverse(B,Abar)+fFe(i,Abar)*fFp_inverse(B,Bbar));
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_91()
{
...
void FSMicromorphic3DT:: Form_II3p_92()
{
...
void FSMicromorphic3DT:: Form_II3p_93()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_93(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Bbar)*fFp_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_94()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                   II3p_94(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Abar)*fChip_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_95()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_95(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fChie(i,Abar)*fFp_inverse(B,Bbar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II3p_96()
{
            ...
            for(int l=0;l<3;l++)
            {
                for(int m=0;m<3;m++)
                {
                    ...
                    for(int Abar=0;Abar<3;Abar++)
                    {
                    	  for(int Bbar=0;Bbar<3;Bbar++)
                    	  {
	                    II3p_96(row,col)+=fTemp_matrix_nsd_x_nsd(m,l)*fdFYchidSIGMA_S(Abar,Bbar)*fFe(i,Bbar)*fChip_inverse(B,Abar);
	                   }
                    }
                    row++;
                }
...
void FSMicromorphic3DT:: Form_II4e_1()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_2()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_3()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_4()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_5()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_6()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_7()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_8()
{
    int row=0;
    int col=0;
...
void FSMicromorphic3DT:: Form_II4p_9()
{
    int row=0;
    int col=0;
