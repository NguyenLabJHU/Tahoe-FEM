...
/*    fH1_8=0.0;
    ...
    ////////////////////////////////////////////////////////////////
    //FSF=0;
     SPK=0.0;// The second Piola-Kirchhoff Matrix
...
/*                    [fLeft_Cauchy_Green_tensor] will be formed
   ...
   //                fEulerian_strain_IPs.SetRow(IP,fTemp_nine_values);
                   ...
                   Form_fV1();
                   fIota_temp_matrix.Multx(fV1,Uint_1_temp);
                   scale=scale_const;
                   Uint_1_temp*=scale;
                   Uint_1 +=Uint_1_temp;
...
/*    for(int n=0;n<3;n++)
    {
    	for(int k=0;k<3;k++)
    	{
    		...
    		for(int l=0;l<3;l++)
    		{
    			I1_2(row,col)+=fTemp_matrix_nsd_x_nsd(n,l);
    			row=row+3;
    		}
        	col++;
    	}
       	...
       	for(int k=0;k<3;k++)
       	{
       		...
       		for(int l=0;l<3;l++)
       		{
       			for(int K=0;K<3;K++)
       			{
       				for(int L=0;L<3;L++)
       				{
       					I1_2(row,col)+=fDeformation_Gradient(n,K)*SPK(K,L)*fDeformation_Gradient(l,L);
       				}
       			}
       			row++;
       		}
        	...
        	for(int l=0;l<3;l++)
        	{
        		...
        		for(int k=0;k<3;k++)
        		{
        			for(int K=0;K<3;K++)
        			{
        				for(int L=0;L<3;L++)
        				{
        					I1_3(row,col)+=fDeformation_Gradient(k,K)*SPK(K,L)*fDeformation_Gradient(m,L);
        				}
        			}
        			row=row+3;
        		}
