...
/* constructor */
RectCubicSplineWindowGPT::RectCubicSplineWindowGPT(const dArrayT& dilation_scaling, double sharpening_factor,
...
void RectCubicSplineWindowGPT::SynchronizeSupportParameters(dArray2DT& params_1, 
	dArray2DT& params_2) const
{
	...
	{
		cout << "\n RectCubicSplineWindowGPT::SynchronizeSupportParameters: nodal\n"
...
void RectCubicSplineWindowGPT::ModifySupportParameters(dArray2DT& nodal_params) const
{
	/* scale supports */
	for (int i = 0; i < fDilationScaling.Length(); i++)
...
void RectCubicSplineWindowGPT::WriteParameters(ostream& out) const
{
		...
		int order, double& w, dArrayT& Dw, dSymMatrixT& DDw, dMatrixT& DDDw) // kyonten (DDDw)
{
  ...
  if (!RectCubicSplineWindowGPT::Covers(x_n, x, param_n))
  {
    w = 0.0;
    if (order > 0)
    {
...
int RectCubicSplineWindowGPT::Window(const dArray2DT& x_n, const dArray2DT& param_n, const dArrayT& x,
...
bool RectCubicSplineWindowGPT::Covers(const dArrayT& x_n, const dArrayT& x, 
...
int RectCubicSplineWindowGPT::Covers(const dArray2DT& x_n, const dArrayT& x, 
