...
#ifndef _RECT_CUBIC_SPLINE_WINDOW_GP_T_H_
#define _RECT_CUBIC_SPLINE_WINDOW_GP_T_H_
...
#include "dMatrixT.h"   //for DDDw

namespace Tahoe {

/** Spherical/circular cubic spline window function */
class RectCubicSplineWindowGPT: public WindowGPT
{
   public:
   
   /* constructor */
	RectCubicSplineWindowGPT(const dArrayT& dilation_scaling, double sharpening_factor,
...
#endif /* _RECT_CUBIC_SPLINE_WINDOW_GP_T_H_ */
