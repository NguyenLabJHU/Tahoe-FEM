/* $Id: BasisT.h,v 1.1 2004-06-18 19:35:09 kyonten Exp $ */
...
public:
	...
	const dArray2DT& DDDP(int component) const; //added KY
...
protected:
	...
	ArrayT<dArray2DT> fDDDP; // [nstr] x [nbasis] x [nnd] //added KY 
...
inline const dArray2DT& BasisT::DDDP(int component) const //added KY
{
