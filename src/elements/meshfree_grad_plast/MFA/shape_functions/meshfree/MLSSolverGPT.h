/* $Id: MLSSolverGPT.h,v 1.1 2004-06-18 19:33:28 kyonten Exp $ */
...
public:
	...
	const dArray2DT& DDDw(void) const;	//added KY
	...
	const dArrayT& DDDb(int component) const;//	added KY

	/* correction function */
	const dArrayT& C(void) const;
	const dArray2DT& DC(void) const;	
	const dArray2DT& DDC(void) const;
	const dArray2DT& DDC(void) const; //added KY
...
private:
	...
	void ComputeDDDM(const dArrayT& volume); //added KY
...
private:
	...
	dSymMatrixT fNSDsym;
	dMatrixT    fMtemp;
	dArrayT fNSDvec; //added KY (for DDDw)
	dArrayT     fbtemp1, fbtemp2, fbtemp3, fbtemp4;
	dArrayT     fbtemp5, fbtemp6, fbtemp7, fbtemp8; //added KY (DDDb)
};
...
inline const dArray2DT& MLSSolverT::DDDphi(void) const { return fDDDphi; }//added KY
...
inline const dArray2DT& MLSSolverT::DDDw(void) const { return fDDDw; }//added KY
...
inline const dArray2DT& MLSSolverT::DDDC(void) const { return fDDDC; }//added KY
...
inline const dArrayT& MLSSolverT::DDDb(int component) const //added KY
{
