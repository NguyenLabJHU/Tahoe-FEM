// $Id: MFGP_Data_ProcessorT.cpp
#include "MFGP_Data_ProcessorT.h" 

using namespace Tahoe;

/* constructor */
MFGP_Data_ProcessorT::MFGP_Data_ProcessorT() { };
...
void MFGP_Data_ProcessorT::Initialize(const double* fN, const dArray2DT& fDN,
...
void MFGP_Data_ProcessorT::Set_B1(dMatrixT& B1 )
{
...
void MFGP_Data_ProcessorT::Set_B3(dMatrixT& B3)
{
#if __option(extended_errorcheck)
...
void MFGP_Data_ProcessorT::Set_psi_lam(dMatrixT& psi_lam) 
{
...
void MFGP_Data_ProcessorT::Set_B4(dMatrixT& B4)  
{
#if __option(extended_errorcheck)
