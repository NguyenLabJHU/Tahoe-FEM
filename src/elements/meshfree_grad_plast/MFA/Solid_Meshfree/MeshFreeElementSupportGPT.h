/* $Id: MeshFreeElementSupportGPT.h,v 1.1 2004-07-08 20:01:13 kyonten Exp $ */
/* created: paklein (11/12/1999) */

#ifndef _MFREE_SUPPORTGP_T_H_
#define _MFREE_SUPPORTGP_T_H_
...
class MeshFreeElementSupportGPT
{
public:

	/** constructor */
	MeshFreeElementSupportGPT(ifstreamT& in);

	/** destructor */
	virtual ~MeshFreeElementSupportGPT(void) { };
...
inline int MeshFreeElementSupportGPT::NumElementNodes(void) const { return fNumElemenNodes; }

} // namespace Tahoe 
#endif /* _MFREE_SUPPORTGP_T_H_ */
