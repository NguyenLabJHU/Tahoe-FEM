/* $Id: MeshFreeSSSolidGPT.h,v 1.1 2004-07-08 20:01:13 kyonten Exp $ */
/* created: paklein (09/11/1998) */

#ifndef _MF_SMALLSTRAINGP_T_H_
#define _MF_SMALLSTRAINGP_T_H_
...
class MeshFreeSSSolidGPT: public SmallStrainT, public MeshFreeFractureSupportT
{
public:

	/* constructor */
	MeshFreeSSSolidGPT(const ElementSupportT& support, const FieldT& field);
