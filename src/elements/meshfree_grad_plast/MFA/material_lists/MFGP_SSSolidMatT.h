/* $Id: MFGP_SSSolidMatT.h,v 1.1 2005-01-06 22:52:21 kyonten Exp $ */
...
class MFGP_SSSolidMatT: public SolidMaterialT
{
public:

	/** constructor */
	MFGP_SSSolidMatT(void);

	/** set the material support or pass NULL to clear */
	virtual void SetMFGPMaterialSupport(const MFGP_MaterialSupportT* support);
	...
	/** laplacian elastic strain */
	const dSymMatrixT& lap_e_last(void);

	/** laplacian elastic strain at the given integration point */
