...
/* array behavior */
namespace Tahoe {
DEFINE_TEMPLATE_STATIC const bool ArrayT<MFGP_SSSolidMatT>::fByteCopy = false;
DEFINE_TEMPLATE_STATIC const bool ArrayT<MFGP_SSSolidMatT*>::fByteCopy = true;
} /* namespace Tahoe */
...
/* constructor */
MFGP_SSSolidMatT::MFGP_SSSolidMatT(void):
	ParameterInterfaceT("mfgp_small_strain_material"),
...
void MFGP_SSSolidMatT::SetMFGPMaterialSupport(const MFGP_MaterialSupportT* support)
{
	/* set inherited material support */
	SetMaterialSupport(support); //continuummaterial
...
const dSymMatrixT& MFGP_SSSolidMatT::e(void)
{
	/* remove thermal strain */
	if (fHasThermalStrain)
	{
		/* thermal strain is purely dilatational */
		fStrainTemp  = fMFGPMaterialSupport->LinearStrain();
		fStrainTemp -= fThermalStrain;
		return fStrainTemp;
	}
	else
		return fMFGPMaterialSupport->LinearStrain();
}

/* elastic strain at the given integration point */
const dSymMatrixT& MFGP_SSSolidMatT::e(int ip)
{
	/* remove thermal strain */
	if (fHasThermalStrain)
	{
		/* thermal strain is purely dilatational */
		fStrainTemp  = fMFGPMaterialSupport->LinearStrain(ip);
		fStrainTemp -= fThermalStrain;
		return fStrainTemp;
	}
	else
		return fMFGPMaterialSupport->LinearStrain(ip);
}

/* strain - returns the elastic strain, ie. thermal removed */
const dSymMatrixT& MFGP_SSSolidMatT::e_last(void)
{
	/* cannot have thermal strain */
	if (fHasThermalStrain)
		ExceptionT::GeneralFail("MFGP_SSSolidMatT::e_last", "not available with thermal strains");
	return fMFGPMaterialSupport->LinearStrain_last();
}

/* elastic strain at the given integration point */
const dSymMatrixT& MFGP_SSSolidMatT::e_last(int ip)
{
	/* cannot have thermal strain */
	if (fHasThermalStrain)
		ExceptionT::GeneralFail("MFGP_SSSolidMatT::e_last", "not available with thermal strains");
	return fMFGPMaterialSupport->LinearStrain_last(ip);
}

/* strain - returns the laplacian of elastic strain */
const dSymMatrixT& MFGP_SSSolidMatT::lap_e(void)
{
	/* cannot have thermal strain */
	if (fHasThermalStrain)
		ExceptionT::GeneralFail("MFGP_SSSolidMatT::lap_e", "not available with thermal strains");
	return fMFGPMaterialSupport->LapLinearStrain();
}

/* laplacian of elastic strain at the given integration point */
const dSymMatrixT& MFGP_SSSolidMatT::lap_e(int ip)
{
	/* cannot have thermal strain */
	if (fHasThermalStrain)
		ExceptionT::GeneralFail("MFGP_SSSolidMatT::lap_e", "not available with thermal strains");
	return fMFGPMaterialSupport->LapLinearStrain(ip);
}

/* strain - returns the laplacian of elastic strain, ie. thermal removed */
const dSymMatrixT& MFGP_SSSolidMatT::lap_e_last(void)
{
	/* cannot have thermal strain */
	if (fHasThermalStrain)
		ExceptionT::GeneralFail("MFGP_SSSolidMatT::lap_e_last", "not available with thermal strains");
	return fMFGPMaterialSupport->LapLinearStrain_last();
}

/* elastic strain at the given integration point */
const dSymMatrixT& MFGP_SSSolidMatT::lap_e_last(int ip)
{
	/* cannot have thermal strain */
	if (fHasThermalStrain)
		ExceptionT::GeneralFail("MFGP_SSSolidMatT::lap_e_last", "not available with thermal strains");
	return fMFGPMaterialSupport->LapLinearStrain_last(ip);
}

/* material description */
const dMatrixT& MFGP_SSSolidMatT::C_IJKL(void)  { return c_ijkl(); }
const dSymMatrixT& MFGP_SSSolidMatT::S_IJ(void) { return s_ij();   }

/* return modulus */
const dMatrixT& MFGP_SSSolidMatT::c_ijkl(void)
{
	...
	dSymMatrixT& strain = const_cast<dSymMatrixT&>(fMFGPMaterialSupport->LinearStrain());
...
void MFGP_SSSolidMatT::InitStep(void)
{
	/* inherited */
...
bool MFGP_SSSolidMatT::SetThermalStrain(dSymMatrixT& thermal_strain)
{
	thermal_strain = 0;
...
const dSymMatrixT& MFGP_SSSolidMatT::AcousticalTensor(const dArrayT& normal)
{
...
void MFGP_SSSolidMatT::Q_2D(const dMatrixT& c_ijkl, const dArrayT& n, dSymMatrixT& Q) const
{
...
void MFGP_SSSolidMatT::Q_3D(const dMatrixT& c_ijkl, const dArrayT& n, dSymMatrixT& Q) const
{
