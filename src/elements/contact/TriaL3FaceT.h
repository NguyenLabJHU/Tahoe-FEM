/* $Id: TriaL3FaceT.h,v 1.1 2001-09-24 20:43:26 rjones Exp $ */
...
(double* a, double* b, double* c) const
{	/* const term */
        a[0] = 0.25*( fx[0][0]+fx[1][0]+2.0*fx[2][0]);
        a[1] = 0.25*( fx[0][1]+fx[1][1]+2.0*fx[2][1]);
        a[2] = 0.25*( fx[0][2]+fx[1][2]+2.0*fx[2][2]);
	/* xi term */ 
        b[0] = 0.25*(-fx[0][0]+fx[1][0]);
        b[1] = 0.25*(-fx[0][1]+fx[1][1]);
        b[2] = 0.25*(-fx[0][2]+fx[1][2]);
	/* eta term */
        c[0] = 0.25*(-fx[0][0]-fx[1][0]+2.0*fx[2][0]);
        c[1] = 0.25*(-fx[0][1]-fx[1][1]+2.0*fx[2][1]);
        c[2] = 0.25*(-fx[0][2]-fx[1][2]+2.0*fx[2][2]);
}
