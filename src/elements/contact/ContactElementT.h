/* $Id: ContactElementT.h,v 1.1 2001-03-22 17:57:42 rjones Exp $ */
...
public:
	...
	/* constructor */
	ContactElementT(FEManagerT& fe_manager, int numfacetnodes);
...
protected:
	/* contact surfaces */
	ArrayT<ContactSurfaceT> fSurfaces; // lists of surfaces

        /* interaction parameters, symmetric matrices */
        MatrixT <dArrayT> fSearchData ;
        MatrixT <dArrayT> fEnforcementData ;
