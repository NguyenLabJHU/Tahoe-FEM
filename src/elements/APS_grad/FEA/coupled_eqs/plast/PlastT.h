// $Id: PlastT.h,v 1.5 2003-10-12 23:48:57 raregue Exp $
#ifndef _PLAST_T_H_ 
#define _PLAST_T_H_ 
...
public:
	...
	virtual void Initialize	(	int &in_ip, int &in_sd, int &in_en, int &in_state, int &in_str, int Initial_Time_Step ) = 0;
