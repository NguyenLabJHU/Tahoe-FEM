...
class	FEA_FormatT {
	...
	public:
		...
		void SurfShapes			(	const ParentDomainT& fSurfShapes, FEA_SurfShapeFunctionT &FEA_SurfShapes, LocalArrayT& face_coords 	);
		...
		void GradientSurface 	(	const ParentDomainT& ,LocalArrayT&,LocalArrayT&,FEA_dMatrixT&,FEA_dMatrixT&	);
