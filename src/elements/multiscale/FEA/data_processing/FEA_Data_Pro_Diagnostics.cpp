...
if (n_sd==2) {
 	...
 	for (int a=0; a<n_en; a++) {
  	...
  	B(0,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k1,k1);       B(0,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k1,k2);    
  	B(1,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k2,k1);       B(1,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k2,k2);    

  	B(2,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k1,k1);       B(2,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k1,k2);    
  	B(3,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k2,k1);       B(3,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k2,k2);    
 ...
 for (int a=0; a<n_en; a++) {
  ...
  B(0,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k1,k1);  B(0,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k1,k2);  B(0,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k1,k3);
  B(1,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k2,k1);  B(1,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k2,k2);  B(1,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k2,k3);
  B(2,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k3,k1);  B(2,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k3,k2);  B(2,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k3,k3);
 
  B(3,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k2,k1);  B(3,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k2,k2);  B(3,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k2,k3);
  B(4,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k1,k1);  B(4,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k1,k2);  B(4,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k3, A2,k1,k3);
  B(5,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k1,k1);  B(5,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k1,k2);  B(5,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k1,k3);

	B(6,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k3,k1);  B(6,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k3,k2);  B(6,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k2, A2,k3,k3);
  B(7,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k3,k1);  B(7,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k3,k2);  B(7,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k3,k3);
  B(8,j0)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k2,k1);  B(8,j1)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k2,k2);  B(8,j2)= dN.Dot_Aij(kCol,a,A1,kCol,k1, A2,k2,k3);
