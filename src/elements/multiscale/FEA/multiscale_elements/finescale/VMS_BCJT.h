// $Id: VMS_BCJT.h,v 1.10 2003-03-17 22:05:32 creigh Exp $
#ifndef _VMS_BCJT_H_ 
#define _VMS_BCJT_H_ 
...
class VMS_BCJT : public FineScaleT
{
    ...
    enum S_T { 	// Scalar values
						   	...
						   	kMag_Ea_dot,
								...
								kJb,
								kJ,
								kpLamda, // for expr G2.Plastic Lamda as in:  S = pLamda*Da
								kRho_Mag_Eb,
								kMag_Eb,
								kPi_Tanh_Rho_Mag_Eb,
  ...
  void 	Form_RHS_F_int	(	dArrayT &F_int ); 
	...
	void 	Control_Eb ( void );	// Forms Eb_tilde 
