...
set TAHOE          = ${HOME}/tahoe-install/tahoe/tahoe
set DAKOTA_UTIL    = ${HOME}/tahoe-install/contrib/Dakota 
set EXTRACT        = extract_1D
set TAHOE_TEMPLATE = pig_lens2a_serial.xml.tmpl
set RESULT_EXT     = io3.exo
