...
set TAHOE_TEMPLATE = pig_lens.xml.tmpl
#set TAHOE_TEMPLATE = pig_lens_q1p0.xml.tmpl
set RESULT_EXT     = io4.exo
set ERROR_FUNC     = least_square
set REF_RESULTS    = datapt1.txt
#set REF_RESULTS    = datapt3.txt
#set REF_RESULTS    = datapt5.txt
