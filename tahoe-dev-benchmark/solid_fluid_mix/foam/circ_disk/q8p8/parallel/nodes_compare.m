...
%%%%%%%%%%%%pore air%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
sim=load('nddata-QuarterCyl-Drained-Displ_1779.txt');
time_drained_air_1779=sim(:,1);
pore_press_drained_air_1779=scale_stress*sim(:,2);
dz_drained_air_1779=sim(:,3);
s33_drained_air_1779=scale_stress*sim(:,4);
pf_drained_air_1779=scale_stress*sim(:,5);
e33_drained_air_1779=sim(:,6);
phi_f_drained_air_1779=sim(:,7);
J_drained_air_1779=sim(:,8);
p_prime_drained_air_1779=scale_stress*sim(:,9);

sim=load('nddata-QuarterCyl-Consol-Displ_1779.txt');
time_consol_air_1779=sim(:,1);
pore_press_consol_air_1779=scale_stress*sim(:,2);
dz_consol_air_1779=sim(:,3);
s33_consol_air_1779=scale_stress*sim(:,4);
pf_consol_air_1779=scale_stress*sim(:,5);
e33_consol_air_1779=sim(:,6);
phi_f_consol_air_1779=sim(:,7);
J_consol_air_1779=sim(:,8);
p_prime_consol_air_1779=scale_stress*sim(:,9);

sim=load('nddata-QuarterCyl-Dyn-Displ_1779.txt');
time_dyn_air_1779=sim(:,1);
pore_press_dyn_air_1779=scale_stress*sim(:,2);
dz_dyn_air_1779=sim(:,3);
s33_dyn_air_1779=scale_stress*sim(:,4);
pf_dyn_air_1779=scale_stress*sim(:,5);
e33_dyn_air_1779=sim(:,6);
phi_f_dyn_air_1779=sim(:,7);
J_dyn_air_1779=sim(:,8);
p_prime_dyn_air_1779=scale_stress*sim(:,9);

% stress, sigmazz
figure(3)
plot(time_drained_air_1779,s33_drained_air_1779,'-k',...
     time_drained_air_abaqus,S22_drained_air_abaqus ,'--k',...
     time_consol_air_1779,s33_consol_air_1779,'-b',...
     time_consol_air_abaqus,S22_consol_air_abaqus,'--b',...
     time_dyn_air_1779,s33_dyn_air_1779,'-r',...
    'LineWidth',1.5)
xlabel('TIME (ms)')
ylabel('STRESS (kPa)')
grid on
title('center node 1779 - pore air')
...
% stress, pf
figure(4)
plot(time_drained_air_1779,pf_drained_air_1779,'o-k',...
     time_consol_air_1779,pf_consol_air_1779,'o-b',...
     time_consol_air_abaqus,POR_consol_air_abaqus,'o--b',...
     time_dyn_air_1779,pf_dyn_air_1779,'o-r',...
    'LineWidth',1.5)
xlabel('TIME (ms)')
ylabel('STRESS (kPa)')
grid on
