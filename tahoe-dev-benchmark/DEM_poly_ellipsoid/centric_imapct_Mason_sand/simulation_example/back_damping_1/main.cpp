...
*/
    ...
    dem::DMP_CNT       = 0;    // normal contact damping ratio
    dem::FRICTION      = 0;     // coefficient of friction between particles
    dem::BDRYFRIC      = 0;     // coefficient of friction between particle and rigid wall
