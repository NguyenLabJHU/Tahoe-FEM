...
int main()
{
    ...
    dem::MASS_SCL      = 10;       // mass scaling
    dem::MNT_SCL       = 10;       // moment of inertial scaling
...
//    dem::DMP_M         = 2.0/dem::TIMESTEP;
    ...
    A.isotropic(100000,             // total_steps
		...
		3.0e+4,             // ambient pressure for final isotropic compression
		100,                // fine steps for applying pressure
		"iso_particle_1k.elp",  // input file, initial particles
...
//	      100,                // number of snapshots
//			"unc_particle_end.elp",     // input file, initial particles
