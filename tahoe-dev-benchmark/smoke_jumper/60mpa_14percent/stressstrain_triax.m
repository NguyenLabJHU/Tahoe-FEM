clear all
%
sim=load('eldata_triax_1.txt');
test7 = importdata('sj_test_7.csv',',',9);
test7_data = test7.data;
test8 = importdata('sj_test_8.csv',',',9);
test8_data = test8.data;
end_step=160;
...
% %
figure(5)
plot(abs(eps22),abs(sig22)-abs(sig11),'LineWidth',2)
hold on
plot(test7_data(:,1)/100,test7_data(:,2),'r','LineWidth',1);
hold on
plot(test8_data(:,1)/100,test8_data(:,2),'r','LineWidth',1);
xlabel('STRAIN')
ylabel('STRESS (MPa)')
