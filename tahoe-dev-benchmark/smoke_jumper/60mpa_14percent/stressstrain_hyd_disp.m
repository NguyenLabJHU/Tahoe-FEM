clear all
%
sim=load('eldata_hyd_disp_1.txt');
test1 = importdata('sj_test_1.csv',',',9);
test1_data = test1.data;
test2 = importdata('sj_test_2.csv',',',9);
...
% %
figure(5)
plot(abs(eps11+eps22+eps33),abs(sig22),'LineWidth',2)
hold on
plot(test1_data(:,1)/100,test1_data(:,2),'r','LineWidth',1);
hold on
plot(test2_data(:,1)/100,test2_data(:,2),'r','LineWidth',1);
xlabel('STRAIN')
ylabel('STRESS (MPa)')
