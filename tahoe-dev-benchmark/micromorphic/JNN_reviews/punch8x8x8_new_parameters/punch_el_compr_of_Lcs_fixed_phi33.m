...
format short e
sim88Lc01=load('el_cube8_Lc01_fixed_phi33_505.txt');
time88Lc01=sim88Lc01(:,1);
trs88Lc01=sim88Lc01(:,num+21);
s_inv88Lc01=sim88Lc01(:,num+22);
trrel88Lc01=sim88Lc01(:,num+23);
rel_inv88Lc01=sim88Lc01(:,num+24);
trm88Lc01=sim88Lc01(:,num+25); %||trm||
hos_inv88Lc01=sim88Lc01(:,num+26);



sim88Lc1=load('el_cube8_Lc1_fixed_phi33_505.txt');
time88Lc1=sim88Lc1(:,1);
trs88Lc1=sim88Lc1(:,num+21);
s_inv88Lc1=sim88Lc1(:,num+22);
trrel88Lc1=sim88Lc1(:,num+23);
rel_inv88Lc1=sim88Lc1(:,num+24);
trm88Lc1=sim88Lc1(:,num+25); %||trm||
hos_inv88Lc1=sim88Lc1(:,num+26);


% 
sim88Lc10=load('el_cube8_Lc10_fixed_phi33_505.txt');
time88Lc10=sim88Lc10(:,1);
trs88Lc10=sim88Lc10(:,num+21);
s_inv88Lc10=sim88Lc10(:,num+22);
trrel88Lc10=sim88Lc10(:,num+23);
rel_inv88Lc10=sim88Lc10(:,num+24);
trm88Lc10=sim88Lc10(:,num+25); %||trm||
hos_inv88Lc10=sim88Lc10(:,num+26);
...
h=legend('Lcptone','Lcone','Lcten','Location','NorthWest');
legend('boxon')
%axis([0 2.5 0 30])
...
h=legend('Lcone','Lcptone','Lcten','Location','SouthWest');
legend('boxon')
%axis([0 2.5 0 30])
%set(gca,'XTickLabel',{'0','1','2','3','4','5','6'})
%set(gca,'YTickLabel',{'0','2','4','6','8','10'})
...
h=legend('Lcone','Lcptone','Lcten','Lchundred','Location','SouthWest');
legend('boxon')
%axis([0 2.5 0 30])
%set(gca,'XTickLabel',{'0','1','2','3','4','5','6'})
%set(gca,'YTickLabel',{'0','2','4','6','8','10'})
