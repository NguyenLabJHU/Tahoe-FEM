...
plot(I1f,snormf,'-k',I1fmid,snormfmid,':k',I1f0,snormf0,'--k',I1_prime,sqrt_sdev_sdev,'.k',p,devSinv,'ok','LineWidth',1)
%plot(I1f,snormf,'-k',I1fmid,snormfmid,':k',I1f0,snormf0,'--k',I1_prime,sqrt_sdev_sdev,'.k',p,devSinv,'ok','LineWidth',1)
...
xlabel('I1')
ylabel('s2J2')
%legend('Ff','Fmid','F0','Gf','sim - intermed config')
legend('Ff','Fmid','F0','sim - intermed config','sim - current config')
grid on
%legend('F','Fmid','F0','sim')
%axis([-100 0 0 12])
%legend('Ff','Fi','Gf','sim')
%legend('Ff','Fi','sim')
set(gca,'FontName','Helvetica','FontSize',16)
