...
%final
 ...
 hc=(sim(length(time),21));
 cx=(sim(length(time),22));
 hcx=(sim(length(time),23));
 Delgamma=(sim(length(time),24));
 Delgammax=(sim(length(time),25));
...
%  devsinv=0.5*((Aphi-Bphi0*pr)+abs(Aphi-Bphi0*pr));
 YieldSurface0=abs(Aphi0-Bphi0*pr+Aphi0x-Bphi0x*prx);
...
figure(2)
plot(time,devrel,'-or','LineWidth',2)
xlabel('time','FontSize',18)
%ylabel('devrel','FontSize',18)
% h=legend('Micromorphic FSE with \lambda, \mu, \kappa,\nu','Micromorphic FSE with \lambda, \mu, \eta,\kappa,\nu','Micromorphic FSE with \lambda, \mu, \eta,\kappa,\nu,\tau,\sigma'...
%     ,'Micromorphic FSE with \lambda, \mu, \eta,\kappa,\nu,\tau,\sigma and \tau_{7 }','Location','NorthWest');
...
figure(3)
plot(time,devsigma,'-or','LineWidth',2)
xlabel('time','FontSize',18)
%ylabel('devrel','FontSize',18)
% h=legend('Micromorphic FSE with \lambda, \mu, \kappa,\nu','Micromorphic FSE with \lambda, \mu, \eta,\kappa,\nu','Micromorphic FSE with \lambda, \mu, \eta,\kappa,\nu,\tau,\sigma'...
%     ,'Micromorphic FSE with \lambda, \mu, \eta,\kappa,\nu,\tau,\sigma and \tau_{7 }','Location','NorthWest');
...
% 
% figure(4)
% plot(Bphi0*pr+Bphi0x*prx,YieldSurface0,'--k',Bphi*pr+Bphix*prx,YieldSurfacefinal,'-k',Bphi*prs+Bphix*prsx,Stress,'-or');
% legend('F0','F','stress path')
