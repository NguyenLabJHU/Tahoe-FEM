...
% % hold on
% % figure(4)
% plot((Bphi0*pr+Bphi0x*prx)*1e-6,YieldSurface0*1e-6,'-.b',(Bphi*pr+Bphix*prx)*1e-6,YieldSurfacefinal*1e-6,'-b',(Bphi*prs+Bphix*prsx)*1e-6,Stress*1e-6,'.-b','markersize',16);
%plot((Bphi*prs+Bphix*prsx)*1e-6,Stress*1e-6,'-xk','LineWidth',2);

%plot(Bphi0*pr*1e-6,YieldSurface0*1e-6,'--b',Bphi*pr*1e-6,YieldSurfacefinal*1e-6,'-b',Bphi*prs*1e-6,Stress*1e-6,'-ob');
%plot(pr,YieldSurface0,'--b',pr,YieldSurfacefinal,'-.b',prs,Stress,'-ob');
%legend('F_0','F','StressTerm')
...
% set(gca,'FontName','Helvetica','FontSize',16)
 ...
 hold on
% figure(2)
%plot(-tre,-trsigma*1e-6,'-b','LineWidth',2)
% figure(3)
% plot(time,devSPK*1e-6,'-b','LineWidth',2)
plot(epsnorm,devsigma*1e-6,'-b','LineWidth',2)
 xlabel('epsnorm','FontSize',18)
 ylabel('devsigma','FontSize',18)
 legend('DP','CDP','Location','SouthEast')
 legend('boxoff')
%plot(time,trsigma*1e-6,'-b','LineWidth',2)
%plot(time,trrel*1e-6,'-b','LineWidth',2)
%plot(time,devrel*1e-6,'-k','LineWidth',2)
%plot(time,trm*1e-6,'-b','LineWidth',2)
%plot(time,devm*1e-6,'-b','LineWidth',2)
...
% ylabel('trrel','FontSize',18)
% legend('MDP','CDP','CDP','Location','SouthEast')
% legend('boxoff')
