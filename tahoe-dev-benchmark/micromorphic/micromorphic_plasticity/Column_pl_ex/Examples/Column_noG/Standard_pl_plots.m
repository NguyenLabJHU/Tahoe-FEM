...
%  YieldSurfacefinal=Aphi-Bphi*pr+Aphix-Bphix*prx;
 ...
 % hold on
% figure(4)
% plot(Bphi0*pr*1e-6,YieldSurface0*1e-6,'-.r',Bphi*pr*1e-6,YieldSurfacefinal*1e-6,'-r',Bphi*prs*1e-6,Stress*1e-6,'.-r','markersize',16);
% xlabel('pr','FontSize',18)
% ylabel('SP','FontSize',18)
% legend('CDP F_0','CDP F','Sc','DP F_0','DP F','Ss','Location','SouthWest')
% legend('boxoff')
% plot(Bphi0*pr*1e-6,YieldSurface0*1e-6,'--r',Bphi*pr*1e-6,YieldSurfacefinal*1e-6,'-r',Bphi*prs*1e-6,Stress*1e-6,'-or');
% legend('CDPF0','CDPF','CDPS','DPF0','DPF','devS','Location','SouthWest')
% xlabel('pr')
% ylabel('SP')
% legend('boxoff')
% %h=legend('Comb.','Macro','Stan.');
% set(gca,'FontName','Helvetica','FontSize',16)  hold on
% figure(1)
%plot(-tre,-trsigma*1e-6,'-r','LineWidth',2)
%  xlabel('-e33percent','FontSize',18)
%  ylabel('-s33MPa','FontSize',18)
%plot(time,devSPK*1e-6,'-r','LineWidth',2)
plot(epsnorm,devsigma*1e-6,'-r','LineWidth',2) 
% %plot(time,trsigma*1e-6,'-r','LineWidth',2) 
%  xlabel('epsnorm','FontSize',18)
%  ylabel('devsigma','FontSize',18)
%  legend('CDP','DP','Location','SouthEast')
%  legend('boxoff')
%  set(gca,'FontName','Helvetica','FontSize',24)
% xlabel('time','FontSize',18)
% ylabel('trsigma','FontSize',18)
% legend('MDP','CDP','DP','Location','SouthWest')
% legend('boxoff')
% xlabel('deve','FontSize',18)
% ylabel('devsigma','FontSize',18)
%  legend('MDP','CDP','DP','Location','SouthEast')
%  legend('boxoff')


 %legend('CDP','MDP','DP','Location','SouthWest')
...
% hold on
% figure(1)
% plot(time,devsigma*1e-6,'-+r','LineWidth',2)
% xlabel('time','FontSize',18)
