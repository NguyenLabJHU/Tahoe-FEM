...
public:
	...
	/*@{*/
	/** configure the field */
	void Initialize(const StringT& name, int ndof, nIntegratorT& controller);
	...
	/** time integrator */
	nIntegratorT& nIntegrator(void) const;
...
/* time integrator */
inline nIntegratorT& FieldT::nIntegrator(void) const
{
