 ...
 * George
 *
 * $Id: pspases.c,v 1.1.1.1 2004-10-07 16:05:26 paklein Exp $
 *
 */
                ...
                int *options, idxtype *order, idxtype *sizes, MPI_Comm *comm)
{
  ...
  int nparts;  /* added -- by Mahesh for PSPASES */
  ...
  nparts = options[2]; /* added -- by Mahesh for PSPASES */

  /* nparts replaced npes in the following call -- by Mahesh for PSPASES */
  ...
  if (mype == 0) {
    ...
    */
    ...
    /* nparts replaced npes in the following call -- by Mahesh for PSPASES */
    METIS_NodeNDP(agraph->nvtxs, agraph->xadj, agraph->adjncy, nparts, seroptions, perm, iperm, sizes); 
  }
  ...
  /* Broadcast the sizes array */
    /* nparts replaced npes in the following call -- by Mahesh for PSPASES */
  MPI_Bcast((void *)sizes, 2*nparts, IDX_DATATYPE, 0, ctrl.gcomm);
