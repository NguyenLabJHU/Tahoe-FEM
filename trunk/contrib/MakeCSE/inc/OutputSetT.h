...
class OutputSetT
{
  public:
	...
	/* constructor */
  	OutputSetT(int ID, GeometryT::GeometryCode geometry_code, 
	...
	GeometryT::GeometryCode Geometry(void) const;
  ...
  private:
  	...
  	int  fID;
	bool fChanging;
  	GeometryT::GeometryCode fGeometry;
...
inline GeometryT::GeometryCode OutputSetT::Geometry(void) const { return fGeometry; }
