...
/* add the number to the diagonal - square matrices ONLY */
void dMatrixT::PlusIdentity(double value)
{
/* must be square */
...
dMatrixT& dMatrixT::Identity(double value)
{
/* must be square */
#if __option (extended_errorcheck)
	if (fRows != fCols) throw eGeneralFail;
