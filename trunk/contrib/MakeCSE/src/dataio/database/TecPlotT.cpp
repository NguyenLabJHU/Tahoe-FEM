...
void TecPlotT::WriteFEZone (ostream& out, const StringT& title, int numnodes, int numelems, GeometryT::GeometryCode code, bool connectivity) const
{
  out << "ZONE ";
...
void TecPlotT::WriteConnectivity (ostream& out, GeometryT::GeometryCode code, const iArray2DT& connects) const
{
  int numnodes = 0;
  switch (code)
    {
