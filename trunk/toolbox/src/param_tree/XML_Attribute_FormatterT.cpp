/* $Id: XML_Attribute_FormatterT.cpp,v 1.12 2004-03-24 01:56:03 paklein Exp $ */
...
static const char* data_type_names[4] = {"xs:integer", "xs:double", "xs:string", "xs:boolean"};
...
bool XML_Attribute_FormatterT::InitDescriptionFile(ostream& out) const
{
	...
	if (fDocType == DTD)
	{
		...
		out << '\n'; 
		out << "<!--Generated by Tahoe::XML_Attribute_FormatterT $Revision: 1.12 $-->";
		return true;
	}
