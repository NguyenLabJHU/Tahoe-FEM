/* $Id: nArray2DT.h,v 1.27 2016-11-05 15:42:01 tdnguye Exp $ */
...
namespace Tahoe {
    ...
    inline void nArray2DT<nTYPE>::RowCopy(int row, nTYPE* array) const
    {
        ...
        this->MemCopy(array, (*this)(row), MinorDim());
    }
    ...
    {
        /* copy */
        this->MemCopy((*this)(row), array, fMinorDim);
    }
    ...
    inline void nArray2DT<nTYPE>::SetRow(int row, const nArrayT<nTYPE>& array)
    {
        ...
        /* copy */
        this->MemCopy((*this)(row), array.Pointer(), fMinorDim);
    }
    ...
    void nArray2DT<nTYPE>::CopyRowFromRow(int copyrow, int fromrow)
    {
        ...
        if (copyrow == fromrow)
            ...
            this->MemCopy((*this)(copyrow), (*this)(fromrow), fMinorDim);
    }
    ...
    void nArray2DT<nTYPE>::BlockRowCopyAt(const nArray2DT& source, int start, int nrows)
    {
        ...
        /* copy */
        this->MemCopy((*this)(start), source.Pointer(), nrows*source.MinorDim());
    }
    ...
    void nArray2DT<nTYPE>::BlockColumnCopyAt(const nArray2DT& source, int start)
    {
        ...
        for (int i = 0; i < fMajorDim; i++)
            this->MemCopy((*this)(i) + start, source(i), source.fMinorDim);
    }
