/* $Id: MultiManagerT.cpp,v 1.6 2004-01-28 01:29:43 hspark Exp $ */
...
void MultiManagerT::Initialize(InitCodeT)
{
	...
	fCoarse->InitProjection(fFine->NonGhostNodes(), bridging_field, *(fFine->NodeManager()), make_inactive, mdmass);
