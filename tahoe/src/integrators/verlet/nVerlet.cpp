/* $Id: nVerlet.cpp,v 1.12.22.1 2005-07-25 02:37:18 paklein Exp $ */
#include "nVerlet.h"
#include "iArrayT.h"
#include "dArrayT.h"
#include "iArray2DT.h"
...
void nVerlet::ConsistentKBC(BasicFieldT& field, const KBC_CardT& KBC, const iArrayT* nodes)
{
	const char caller[] = "nVerlet::ConsistentKBC";
