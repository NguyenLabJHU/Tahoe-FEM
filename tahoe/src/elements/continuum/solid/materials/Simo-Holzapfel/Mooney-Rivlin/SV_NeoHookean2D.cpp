/* $Id: SV_NeoHookean2D.cpp,v 1.3 2002-10-20 22:48:53 paklein Exp $ */
...
SV_NeoHookean2D::SV_NeoHookean2D(ifstreamT& in, const FiniteStrainT& element):
         FDSimoVisco2D(in, element),
	 fMu(2),
	 fKappa(2),
	 fCbar(2)
{
