/* $Id: SSSolidMatList3DT.cpp,v 1.1.6.1 2004-07-06 06:53:52 paklein Exp $ */
...
#ifdef PLASTICITY_J2_MATERIAL
		sub_sub_list.AddSub("small_strain_StVenant_J2");
#endif
...
#ifdef PLASTICITY_J2_MATERIAL
	else if (list_name == "small_strain_StVenant_J2")
		mat = new J2SSKStV;
#endif
