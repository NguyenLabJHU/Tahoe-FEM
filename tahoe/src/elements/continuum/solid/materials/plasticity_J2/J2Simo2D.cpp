/* $Id: J2Simo2D.cpp,v 1.13.28.1 2004-07-06 06:53:57 paklein Exp $ */
...
ParameterInterfaceT* J2Simo2D::NewSub(const StringT& list_name) const
{
	/* inherited */
	ParameterInterfaceT* sub = SimoIso2D::NewSub(list_name);
	if (sub)
		return sub;
	else
