/* slamch.f -- translated by f2c (version 19971204).
...
real slamch(char *cmach, ftnlen cmach_len)
{
    /* Initialized data */
    ...
    extern /* Subroutine */ int slamc2(integer *, integer *, logical *, real 
...
/* Subroutine */ int slamc1(integer *beta, integer *t, logical *rnd, logical 
	*ieee1)
{
    /* Initialized data */
...
/* Subroutine */ int slamc2(integer *beta, integer *t, logical *rnd, real *
	eps, integer *emin, real *rmin, integer *emax, real *rmax)
{
    ...
    static logical lieee1;
    extern /* Subroutine */ int slamc1(integer *, integer *, logical *, 
	    logical *);
    extern real slamc3(real *, real *);
    extern /* Subroutine */ int slamc4(integer *, real *, integer *), 
	    slamc5(integer *, integer *, integer *, logical *, integer *, 
	    real *);
...
/* Computing 2nd power */
	    ...
	    c__ = slamc3(&r__1, &r__2);
	    r__1 = -c__;
	    c__ = slamc3(&half, &r__1);
	    b = slamc3(&half, &c__);
	    r__1 = -b;
	    c__ = slamc3(&half, &r__1);
	    b = slamc3(&half, &c__);
...
/* Subroutine */ int slamc4(integer *emin, real *start, integer *base)
{
    /* System generated locals */
    integer i__1;
    real r__1;
...
/* Subroutine */ int slamc5(integer *beta, integer *p, integer *emin, 
