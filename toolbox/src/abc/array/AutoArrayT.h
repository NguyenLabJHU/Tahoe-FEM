/* $Id: AutoArrayT.h,v 1.21 2016-11-05 15:42:01 tdnguye Exp $ */
...
namespace Tahoe {
    ...
    AutoArrayT<TYPE>& AutoArrayT<TYPE>::operator=(const AutoArrayT<TYPE>& RHS)
    {
        ...
        if (this->fArray != RHS.Pointer())
        {
            ...
            /* copy data */
            this->MemCopy(this->fArray, RHS.Pointer(), this->fLength);
        }
    ...
    void AutoArrayT<TYPE>::Append(const ArrayT<TYPE>& source)
    {
        ...
        if (this->fLength + source.Length() >= fMemSize)
        {
            ...
            this->MemCopy(this->fArray, olddata, this->fLength);
        ...
        this->MemCopy(this->fArray + this->fLength, source.Pointer(), source.Length());
    ...
    inline void AutoArrayT<TYPE>::CopyInto(ArrayT<TYPE>& RHS) const
    {
        ...
        /* copy logical size */
        this->MemCopy(RHS.Pointer(), this->fArray, this->fLength);
    }
