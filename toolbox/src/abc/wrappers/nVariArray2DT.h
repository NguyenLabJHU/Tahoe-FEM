/* $Id: nVariArray2DT.h,v 1.12 2016-11-05 15:42:05 tdnguye Exp $ */
...
namespace Tahoe {
    ...
    inline void nVariArray2DT<nTYPE>::SetMajorDimension(int majordim, bool copy_in)
    {
        ...
        /* update ArrayT data */
        this->SetAlias(*fWard, majordim*fMinorDim, copy_in);
                                                        ...
                                                        const nTYPE& fill, bool copy_in)
    {
        ...
        /* update ArrayT data */
        this->SetAlias(*fWard, majordim*fMinorDim, fill, copy_in);
    ...
    void nVariArray2DT<nTYPE>::Swap(nArray2DT<nTYPE>& source)
    {
        ...
        this->SetAlias(*fWard, major_dim*fMinorDim, true);
