 ...
 *====================================================================*/
#ifndef lint
static char rcsid[] = "$Id: az_sort.c,v 1.1.1.1 2001-01-30 20:59:13 paklein Exp $";
#endif
...
#ifndef __MWERKS__
#include <memory.h> /* non-standard header? PAK (09/07/2000) */
#endif

#include <string.h> /* missing header - PAK (07/24/98) */
#include "az_aztec.h"
