// DEVELOPMENT
/* $Id: AsperityT.cpp,v 1.5 2003-06-13 17:27:28 saubry Exp $ */
#include "AsperityT.h"
#include "VolumeT.h"
...
void AsperityT::SortLattice(CrystalLatticeT* pcl) 
{
  ...
  if(nlsd == 3)
  {
	...
	dArrayT aux_typ(Ind[n+1]-Ind[n]); aux_typ = 0;
	dArrayT aux_par(Ind[n+1]-Ind[n]); aux_par = 0;
